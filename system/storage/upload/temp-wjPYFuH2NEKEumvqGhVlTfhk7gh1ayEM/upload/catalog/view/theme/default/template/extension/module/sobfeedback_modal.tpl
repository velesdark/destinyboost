<button type="button" class="btn btn-default" data-toggle="modal" data-target="#feedbackModal<?php echo $module_id; ?>">
    <i class="fa fa-envelope-o"></i> <?php echo $button_name; ?>
</button>
<div class="modal fade" id="feedbackModal<?php echo $module_id; ?>" tabindex="-1" role="dialog"
     aria-labelledby="feedbackModalLabel<?php echo $module_id; ?>">
        ...
        <div class="modal-content col-md-12">
            <div class="modal-header">
                ...
                <h4 class="modal-title"
                    id="feedbackModalLabel<?php echo $module_id; ?>"><?php echo $module_name; ?></h4>
            </div>
                ...
                <form role="form" data-toggle="validator" enctype="multipart/form-data"
                    ...
                    <div class="form-group required">
                        ...
                        <textarea class="form-control"
                                  name="sob_input[<?php echo $field_row; ?>][<?php echo $field['name']; ?>]"
                                  id="sobInputText" rows="3" data-minlength="5" required=""
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control"
                                  name="sob_input[<?php echo $field_row; ?>][<?php echo $field['name']; ?>]"
                                  id="sobInputText" rows="3" placeholder="<?php echo $field['name']; ?>"></textarea>
                    </div>
                    <?php } ?>
