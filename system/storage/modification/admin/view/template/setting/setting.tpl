                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab-local">
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-sm-2 control-label" for="input-currency"><span data-toggle="tooltip"
                                                                                                 title="Выводится модулем autocalc_price_option в карточке товара">Дополнительная валюта <i>(autocalc)</i>:</span></label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-currency"><span data-toggle="tooltip"
                                                                                                 title="Акция на опции пропорционально акции на товар (autocalc_price_option)">Акция на опции <i>(autocalc)</i>:</span></label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-currency"><span data-toggle="tooltip"
                                                                                                 title="Скидка на опции пропорционально скидке на товар (autocalc_price_option)">Скидка на опции <i>(autocalc)</i>:</span></label>
                                <div class="col-sm-10">
                                    <label class="radio-inline">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-currency"><span data-toggle="tooltip"
                                                                                                 title="Отключении функции умножения на количество (autocalc_price_option)">Не умножать на количество <i>(autocalc)</i>:</span></label>
                                <div class="col-sm-10">
                                    <label class="radio-inline">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-currency"><span data-toggle="tooltip"
                                                                                                 title="Автоматический выбор первой опции (radio,select). (autocalc_price_option)">Выбор первой опции <i>(autocalc)</i>:</span></label>
                                <div class="col-sm-10">
                                    <label class="radio-inline">
