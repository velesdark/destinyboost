                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product"
                    ...
                    <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                        ...
                        <div class="tab-pane" id="tab-links">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="input-category"><?php echo $entry_main_category; ?></label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="input-category"><?php echo $entry_category; ?></label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-related"><span data-toggle="tooltip"
                                                                                                title="<?php echo $help_related; ?>"><?php echo $entry_related; ?></span></label>
                                <div class="col-sm-10">
					...
					?>
                                        ...
                                        <li><a href="#tab-option<?php echo $option_row; ?>" data-toggle="tab"><i
                                                        ...
                                                        onclick="master_option_del(<?php echo $option_row; ?>); $('a[href=\'#tab-option<?php echo $option_row; ?>\']').parent().remove(); $('#tab-option<?php echo $option_row; ?>').remove(); $('#option a:first').tab('show');"></i> <?php echo $product_option['name']; ?>
                                            </a></li>
                                        <?php $option_row++; ?>
                                        <?php } ?>
                                        <li>
                                ...
                                <div class="col-sm-10">
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="tab-option<?php echo $option_row; ?>">
                                            ...
                                            <input type="hidden" name="product_option[<?php echo $option_row; ?>][name]"
                                            ...
                                            <input type="hidden" name="product_option[<?php echo $option_row; ?>][type]"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <select name="product_option[<?php echo $option_row; ?>][master_option]"
                                                            class="form-control">
                                                        <option value="0"><?php echo $text_no; ?></option>
                                                        ...
                                                        <option value="<?php echo $product_option1['option_id']; ?>"
                                                                selected="selected"><?php echo $product_option1['name']; ?></option>
                                                        <?php } else { ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-master-<?php echo $option_row; ?>"
                                                     data-col="<?php echo $option_row; ?>" data-row="0">
                                                    <?php if ($product_option['master_option']) { ?>
                                                    <select name="product_option[<?php echo $option_row; ?>][master_option_value]"
                                                        ...
                                                        <option value="<?php echo $master_option_value['option_value_id']; ?>"
                                                                selected="selected"><?php echo $master_option_value['name']; ?></option>
                                                        <?php } else { ?>
                                                    ...
                                                    <?php } else { ?>
                                                    - <input type="hidden"
                                                             name="product_option[<?php echo $option_row; ?>][master_option_value]"
                                                             value="0">
                                                    <?php }?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea name="product_option[<?php echo $option_row; ?>][value]"
                                                              rows="5" placeholder="<?php echo $entry_option_value; ?>"
                                                              id="input-value<?php echo $option_row; ?>"
                            ...
                            <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                                                ...
                                                <table id="option-value<?php echo $option_row; ?>"
                                                    ...
                                                    <tr id="option-value-row<?php echo $option_value_row; ?>">
                                                        <td class="text-left"><select
                                                                    name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][option_value_id]"
                                                                    class="form-control">
                                                        ...
                                                        <td class="text-right"><select
                                                                    name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][price_prefix]"
                                                                    class="form-control">
                                                        ...
                                                        <td class="text-right"><select
                                                            ...
                                                            <input type="text"
                                                                   ...
                                                                   value="<?php echo $product_option_value['points']; ?>"
                                                        ...
                                                        <td class="text-right"><select
                                                            ...
                                                            <input type="text"
                                                                   ...
                                                                   placeholder="<?php echo $entry_weight; ?>"
                                                                   class="form-control"/></td>
                                                        <!--BOF Related Options-->
                                                        <td class="right col-master-<?php echo $option_row; ?>"
                                                            data-col="<?php echo $option_row; ?>"
                                                            data-row="<?php echo $option_value_row; ?>">
                                                            <?php if ($product_option['master_option']) { ?>
                                                            ...
                                                            <center>-</center>
                                                            <input type="hidden"
                                                                   name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][master_option_value]"
                                                                   value="0">
                                                            <?php }?>
                                                        </td>
                                                        <!--EOF Related Options-->
                                            ...
                                            <!--BOF Related Options-->
                                            <?php if ($product_option['master_option']) { ?>
                                            <select id="master-option-values<?php echo $option_row; ?>"
                                ...
                                <table id="images" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr id="image-row<?php echo $image_row; ?>">
                                        <td class="text-left"><a href="" id="thumb-image<?php echo $image_row; ?>"
                                                        ...
                                                        data-placeholder="<?php echo $placeholder; ?>"/></a><input
                                                    type="hidden" name="product_image[<?php echo $image_row; ?>][image]"
