...
class ModelExtensionPaymentWebmoneyWMZ extends Model
{
    public function getMethod($address, $total)
    {
        ...
        if (($this->config->get('webmoney_wmz_status')) && ($total) &&
            (!$this->config->get('webmoney_wmz_minimal_order') || ($total >= (float)$this->config->get('webmoney_wmz_minimal_order'))) &&
            (!$this->config->get('webmoney_wmz_maximal_order') || ($total <= (float)$this->config->get('webmoney_wmz_maximal_order')))) {
            ...
            //hide_mode
            if ($this->config->get('webmoney_wmz_hide_mode')) {
