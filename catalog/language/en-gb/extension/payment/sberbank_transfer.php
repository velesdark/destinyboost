...
$_['text_confirm'] = 'Caution! Wait for receipt loading!!!!\n\n-Then check again the correctness of the entered payment data.\n- If an error is detected, click "Cancel" and edit the form.\n- If everything is OK, click on "OK" - the form will be sent to the printer.';
?>