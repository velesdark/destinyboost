<?php
// Text
$_['text_title'] = 'Klarna Account - оплата от %s в месяц';
...
$_['text_information'] = 'Данные Klarna Account';
$_['text_additional'] = 'Системе Klarna Account необходимы некоторые дополнительные данные для дальнейшей обработки заказа.';
$_['text_male'] = 'Мужской';
...
$_['text_single_payment'] = 'Единовременный платеж';
...
// Help
$_['help_pno'] = 'Номер социального страхования (для Швеции)';
...
$_['error_address_match'] = 'Адреса плательщика и получателя заказа должны совпадать, если Вы хотите использовать Klarna Payments';
