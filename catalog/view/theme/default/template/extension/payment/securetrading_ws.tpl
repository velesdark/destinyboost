<form class="form-horizontal">
    <fieldset id="payment">
        ...
        <div class="form-group required">
            ...
            <div class="col-sm-10">
                <input type="text" name="number" value="" placeholder="<?php echo $entry_number; ?>" id="input-number"
                       class="form-control"/>
            </div>
        </div>
        ...
        <div class="form-group required">
            ...
            <div class="col-sm-10">
                <input type="text" name="cvv2" value="" placeholder="<?php echo $entry_cvv2; ?>" id="input-cvv2"
                       class="form-control"/>
            </div>
        </div>
