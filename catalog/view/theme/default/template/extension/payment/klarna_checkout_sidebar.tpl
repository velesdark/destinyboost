        ...
        <table class="table-klarna">
            ...
            <tr>
                ...
                <td class="text-center">
                    <button type="button" onclick="kc.cartRemove('<?php echo $product['cart_id']; ?>');"
                            title="<?php echo $button_remove; ?>" class="btn-link"><i class="fa fa-times"></i></button>
                </td>
            </tr>
            <?php } ?>
            ...
            <tr>
                ...
                <td class="text-center">
                    <button type="button" onclick="kc.voucherRemove('<?php echo $voucher['key']; ?>');"
                            title="<?php echo $button_remove; ?>" class="btn-link"><i class="fa fa-times"></i></button>
                </td>
            </tr>
            <?php } ?>
