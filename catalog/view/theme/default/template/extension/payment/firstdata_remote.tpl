    ...
    <fieldset id="payment">
        ...
        <div class="form-group">
            <div class="col-sm-12">
                ...
                <p><input type="radio" name="cc_choice" value="<?php echo $card['token']; ?>"
                          class="stored_card" <?php echo $i == 0 ? 'checked="checked"' : ''; ?>
                    /> <?php echo $card['card_type'] . ' xxxx ' . $card['digits'] . ', ' . $entry_cc_expire_date . ' ' . $card['expire_month'] . '/' . $card['expire_year']; ?>
                </p>
                <?php $i++; ?>
                <?php } ?>
        ...
        <div id="card_info" style="display:none;">
            <div class="form-group required">
                ...
                <div class="col-sm-10">
                    <input type="text" name="cc_name" value="" placeholder="<?php echo $entry_cc_name; ?>"
                           id="input-cc-name" class="form-control"/>
                </div>
            </div>
            <div class="form-group required">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="hidden" name="cc_store" value="0"/> <input type="checkbox" name="cc_store" value="1"
                                                                            checked/>
                </div>
            </div>
            <?php } ?>
