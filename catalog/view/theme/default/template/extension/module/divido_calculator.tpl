...
<div id="divido-checkout" data-divido-calculator class="divido-calculator divido-theme-blue"
     data-divido-amount="<?php echo $product_price; ?>" data-divido-plans="<?php echo $plan_list; ?>">
    <h1>
    ...
    <dl>
        ...
        <dd><span class="divido-deposit" data-divido-choose-deposit
                  data-divido-label="<?php echo $text_choose_deposit; ?>" data-divido-form="divido_deposit"></span></dd>
    </dl>
    <div class="description">
        <strong>
            <span data-divido-agreement-duration></span> <?php echo $text_monthly_payments; ?> <span
