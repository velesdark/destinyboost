...
<div class="simple-content">
    ...
    <script type="text/javascript">
        var startSimpleInterval = window.setInterval(function () {
            ...
            :
                ...
                function () {<?php echo $javascript_callback ?>}
            })
                ;
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="simplepage_form">
        <div class="simpleregister" id="simpleregister">
            ...
            <?php if ($error_agreement) { ?>data-error="true"<?php } else { ?>style="display:none;"<?php } ?>
        ...
        <div class="simpleregister-button-block buttons">
            <div class="simpleregister-button-right">
                ...
                <?php } ?>
                <a class="button btn-primary button_oc btn" data-onclick="submit"
                   id="simpleregister_button_confirm"><span><?php echo $button_continue; ?></span></a>
            </div>
        </div>
</div>
<?php if ($redirect) { ?>
