...
<form class="form-horizontal" id="payment">
    <div class="form-group required">
        ...
        <div class="col-sm-10">
            <input type="text" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false"
                   maxlength="32" name="holder" placeholder="<?php echo $entry_holder; ?>" id="input-holder"
                   class="form-control"/>
        </div>
    </div>
    <div class="form-group required">
        ...
        <div class="col-sm-10">
            <input type="text" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false"
                   maxlength="19" name="pan" placeholder="<?php echo $entry_pan; ?>" id="input-pan"
                   class="form-control"/>
        </div>
    </div>
    ...
    <div class="form-group required">
        ...
        <div class="col-sm-10">
            <input type="text" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false"
                   maxlength="4" name="cvc" placeholder="<?php echo $entry_cvc; ?>" id="input-cvc"
                   class="form-control"/>
        </div>
    </div>
