<div class="content">
    ...
    <form action="<?php echo $action; ?>" method="get" id="payments">
        ...
        <?php if ($summ < 15000) { ?>
        <div style="text-align: right;"><?php echo $sub_text_info_phone; ?><input type="text" name="qiwi_phone"
                                                                                  value="<?php echo $phone; ?>"
                                                                                  size="15" maxlength="15"></div>
        <div style="text-align: right; color: red;" id="qiwi_error"></div>


        <div style="text-align: right;"><?php echo $qiwi_continue; ?> <input
                    type="checkbox" <?php if (isset($qiwi_rest_show_pay_now)) echo 'checked'; ?> name="qiwi_continue"
            id="qiwi_continue">
        </div>
    ...
    <div class="buttons">
        <div class="pull-right">
            ...
            <?php } else { ?>
            <input type="button" value="<?php echo $button_back; ?>" id="payment_back" class="btn btn-primary"
                   data-loading-text="<?php echo $text_loading; ?>"/>
            <?php } ?>
