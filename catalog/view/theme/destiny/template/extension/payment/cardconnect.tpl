<form id="cardconnect-form" action="<?php echo $action; ?>" method="post" class="form form-horizontal">
    <fieldset id="payment">
        ...
        <div class="card_container">
            <div class="form-group"
            <?php if (!$store_cards) { echo 'style="display:none"'; } ?>>
        ...
        <div class="card_new_container">
            ...
            <div class="form-group required">
                ...
                <div class="col-sm-10">
                    <input type="text" name="card_number" value="" placeholder="<?php echo $entry_card_number; ?>"
                           id="input-card-number" class="form-control"/>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group required">
                ...
                <div class="col-sm-10">
                    <input type="text" name="card_cvv2" value="" placeholder="<?php echo $entry_card_cvv2; ?>"
                           id="input-card-cvv2" class="form-control"/>
                </div>
            </div>
            <?php if ($store_cards) { ?>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="input-card-save"
                       style="padding-top:0"><?php echo $entry_card_save; ?></label>
                <div class="col-sm-10">
        ...
        <div class="card_old_container" style="display:none">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <select name="card_choice" id="input-card-choice"
                            class="form-control" <?php if (!$cards) { echo 'disabled'; } ?>>
                    <?php if ($cards) { ?>
                ...
                <div class="col-sm-2">
                    <input type="button" value="<?php echo $button_delete; ?>" id="button-delete"
                           data-loading-text="<?php echo $text_loading; ?>" class="btn btn-danger"/>
                </div>
            </div>
        </div>
        </div>
        <div class="echeck_container" style="display:none">
            <div class="form-group required">
                <label class="col-sm-2 control-label"
                       for="input-account-number"><?php echo $entry_account_number; ?></label>
                <div class="col-sm-10">
                    <input type="text" name="account_number" value="" placeholder="<?php echo $entry_account_number; ?>"
                           id="input-account-number" class="form-control"/>
                </div>
            </div>
            <div class="form-group required">
                <label class="col-sm-2 control-label"
                       for="input-routing-number"><?php echo $entry_routing_number; ?></label>
                <div class="col-sm-10">
                    <input type="text" name="routing_number" value="" placeholder="<?php echo $entry_routing_number; ?>"
                           id="input-routing-number" class="form-control"/>
                </div>
            </div>
        </div>
    </fieldset>
