...
<iframe name="hss_iframe" width="560px" height="540px" style="border:0px solid #DDDDDD; margin-left:210px;"
        scrolling="no"
        src="<?php echo HTTPS_SERVER.'index.php?route=extension/payment/pp_pro_iframe/create'; ?>"></iframe>
<?php } else { ?>
