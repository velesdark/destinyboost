...
<form id="payment" class="form-horizontal">
    <fieldset>
        ...
        <div class="form-group required">
            ...
            <div class="col-sm-10">
                <input type="text" name="house_no" value="<?php echo $street_number; ?>" id="input-house-no"
                       class="form-control"/>
            </div>
        </div>
        <?php } ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="house_ext" value="<?php echo $street_extension; ?>" id="input-house-ext"
                       class="form-control"/>
            </div>
        </div>
        <?php } ?>
        <div class="form-group required">
            ...
            <div class="col-sm-10">
                <input type="text" name="phone_no" value="<?php echo $phone_number; ?>" id="input-phone-no"
                       class="form-control"/>
            </div>
        </div>
        ...
        <div class="radio">
            ...
            Mit der Übermittlung der für die Abwicklung des Rechnungskaufes und einer Identitäts - und Bonitätsprüfung
            erforderlichen
            Daten an Klarna bin ich einverstanden. Meine <a href="https://online.klarna.com/consent_de.yaws"
                                                            target="_blank">Einwilligung</a> kann ich jederzeit mit
