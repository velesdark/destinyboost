    ...
    <div class="row"><?php echo $column_left; ?>
        ...
        <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td class="text-right"><a href="<?php echo $delete . $card['card_id']; ?>"
                                                  class="btn btn-danger"><?php echo $button_delete; ?></a></td>
            ...
            <div class="buttons clearfix">
                ...
                <div class="pull-right"><input type="button" value="<?php echo $button_new_card; ?>"
                                               id="button-add-card" data-loading-text="<?php echo $text_loading; ?>"
