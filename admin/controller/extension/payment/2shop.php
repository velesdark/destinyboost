...
class ControllerExtensionPayment2shop extends Controller
{
    private $error = array();
    private $version = '3.3.ik';
    const MAX_LAST_LOG_LINES = 500;
    const FILE_NAME_LOG = '2shop.log';

    public function __construct($registry)
    {
        parent::__construct($registry);
        $this->load->language('extension/payment/2shop');
    ...
    public function index()
    {
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
            ...
            $this->model_setting_setting->editSetting('2shop', $this->request->post);
        ...
        $data = $this->_setData(array(
            ...
            'test',
            'button_clear',
            'action' => $this->makeUrl('extension/payment/2shop'),
            'cancel' => $this->makeUrl('extension/extension', 'type=payment'),
            'clear_log' => $this->makeUrl('extension/payment/2shop/clearLog'),
            ...
            'shoputils_ik_success_url' => $server . 'index.php?route=extension/payment/2shop/success',
            'shoputils_ik_fail_url' => $server . 'index.php?route=extension/payment/2shop/fail',
            'shoputils_ik_pending_url' => $server . 'index.php?route=extension/payment/2shop/success',
            'shoputils_ik_status_url' => $server . 'index.php?route=extension/payment/2shop/status',
            ...
            'log_lines' => $this->readLastLines(DIR_LOGS . '2shop.log', self::MAX_LAST_LOG_LINES),
        ...
        $data['breadcrumbs'][] = array(
           'href'      => $this->makeUrl('extension/payment/2shop'),
        ...
        $this->response->setOutput($this->load->view('extension/payment/2shop', $data));
    }
    ...
    {
        return $this->user->hasPermission('modify', 'extension/payment/2shop');
    }
