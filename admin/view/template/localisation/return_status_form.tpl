    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-return-status" data-toggle="tooltip"
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                      id="form-return-status" class="form-horizontal">
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="input-group"><span class="input-group-addon"><img
                                ...
                                <input type="text" name="return_status[<?php echo $language['language_id']; ?>][name]"
                                       value="<?php echo isset($return_status[$language['language_id']]) ? $return_status[$language['language_id']]['name'] : ''; ?>"
