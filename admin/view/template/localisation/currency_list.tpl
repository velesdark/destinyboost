    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right"><a href="<?php echo $refresh; ?>" data-toggle="tooltip"
                                       title="<?php echo $button_currency; ?>" class="btn btn-warning"><i
                            class="fa fa fa-refresh"></i></a> <a href="<?php echo $add; ?>" data-toggle="tooltip"
                ...
                <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger"
                        onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-currency').submit() : false;"><i
                            ...
                            <tr>
                                <td class="text-center"><?php if (in_array($currency['currency_id'], $selected)) { ?>
                                    <input type="checkbox" name="selected[]"
                                           value="<?php echo $currency['currency_id']; ?>" checked="checked"/>
                                    <?php } else { ?>
                                    <input type="checkbox" name="selected[]"
                                ...
                                <td class="text-right"><a href="<?php echo $currency['edit']; ?>" data-toggle="tooltip"
