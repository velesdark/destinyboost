        ...
        <div class="container-fluid">
            <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip"
                ...
                <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger"
                        onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-return-action').submit() : false;">
                            ...
                            <tr>
                                <td class="text-center"><?php if (in_array($return_action['return_action_id'], $selected)) { ?>
                                    <input type="checkbox" name="selected[]"
                                           value="<?php echo $return_action['return_action_id']; ?>" checked="checked"/>
                                    <?php } else { ?>
                                    <input type="checkbox" name="selected[]"
                                           value="<?php echo $return_action['return_action_id']; ?>"/>
                                    <?php } ?></td>
                                <td class="text-left"><?php echo $return_action['name']; ?></td>
                                <td class="text-right"><a href="<?php echo $return_action['edit']; ?>"
