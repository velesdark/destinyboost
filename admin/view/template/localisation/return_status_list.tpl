        ...
        <div class="container-fluid">
            <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip"
                ...
                <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger"
                        onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-return-status').submit() : false;">
                            ...
                            <tr>
                                <td class="text-center"><?php if (in_array($return_status['return_status_id'], $selected)) { ?>
                                    <input type="checkbox" name="selected[]"
                                           value="<?php echo $return_status['return_status_id']; ?>" checked="checked"/>
                                    <?php } else { ?>
                                    <input type="checkbox" name="selected[]"
                                           value="<?php echo $return_status['return_status_id']; ?>"/>
                                    <?php } ?></td>
                                <td class="text-left"><?php echo $return_status['name']; ?></td>
                                <td class="text-right"><a href="<?php echo $return_status['edit']; ?>"
