        ...
        <div class="container-fluid">
            <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip"
                ...
                <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger"
                        onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-location').submit() : false;"><i
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="text-left"><?php if ($sort == 'address') { ?>
                                    <a href="<?php echo $sort_address; ?>"
                                       class="<?php echo strtolower($order); ?>"><?php echo $column_address; ?></a>
                                    <?php } else { ?>
                            ...
                            <tr>
                                <td class="text-center"><?php if (in_array($locations['location_id'], $selected)) { ?>
                                    <input type="checkbox" name="selected[]"
                                           value="<?php echo $locations['location_id']; ?>" checked="checked"/>
                                    <?php } else { ?>
                                    <input type="checkbox" name="selected[]"
                                ...
                                <td class="text-right"><a href="<?php echo $locations['edit']; ?>" data-toggle="tooltip"
