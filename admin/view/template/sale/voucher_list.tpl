        ...
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger"
                        onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-voucher').submit() : false;"><i
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="text-left"><?php if ($sort == 'v.from_name') { ?>
                                    <a href="<?php echo $sort_from; ?>"
                                       class="<?php echo strtolower($order); ?>"><?php echo $column_from; ?></a>
                                    <?php } else { ?>
                                    <a href="<?php echo $sort_from; ?>"><?php echo $column_from; ?></a>
                                    <?php } ?></td>
                                <td class="text-left"><?php if ($sort == 'v.to_name') { ?>
                                    <a href="<?php echo $sort_to; ?>"
                                ...
                                <td class="text-left"><?php if ($sort == 'theme') { ?>
                                    <a href="<?php echo $sort_theme; ?>"
                                       class="<?php echo strtolower($order); ?>"><?php echo $column_theme; ?></a>
                                    <?php } else { ?>
                            ...
                            <tr>
                                <td class="text-center"><?php if (in_array($voucher['voucher_id'], $selected)) { ?>
                                    <input type="checkbox" name="selected[]"
                                           value="<?php echo $voucher['voucher_id']; ?>" checked="checked"/>
                                    <?php } else { ?>
                                    <input type="checkbox" name="selected[]"
                                ...
                                <td class="text-right">
                                    ...
                                    <a href="<?php echo $voucher['order']; ?>" data-toggle="tooltip"
                                       title="<?php echo $button_order; ?>" class="btn btn-info"><i
                                                class="fa fa fa-eye"></i></a>
                                    <?php } ?>
                                    <a href="<?php echo $voucher['edit']; ?>" data-toggle="tooltip"
