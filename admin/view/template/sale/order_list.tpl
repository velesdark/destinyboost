    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <button type="button" id="button-delete" form="form-order" formaction="<?php echo $delete; ?>"
                        data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger"><i
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="text-right"><a href="<?php echo $order['view']; ?>" data-toggle="tooltip"
                                                ...
                                                class="fa fa-eye"></i></a> <a href="<?php echo $order['edit']; ?>"
                                                                              data-toggle="tooltip"
