                ...
                <div class="well">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label"
                                       for="input-order-recurring-id"><?php echo $entry_order_recurring_id; ?></label>
                                <input type="text" name="filter_order_recurring_id"
                                       value="<?php echo $filter_order_recurring_id; ?>"
                                       placeholder="<?php echo $entry_order_recurring_id; ?>"
                                       id="input-order-recurring-id" class="form-control"/>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <select name="filter_status" id="input-status" class="form-control">
                                    ...
                                    <option value="<?php echo $recurring_status['value']; ?>"
                                            selected="selected"><?php echo $recurring_status['text']; ?></option>
                                    <?php } else { ?>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label"
                                       for="input-reference"><?php echo $entry_reference; ?></label>
                                <input type="text" name="filter_reference" value="<?php echo $filter_reference; ?>"
                                       placeholder="<?php echo $entry_reference; ?>" id="input-reference"
                                       class="form-control"/>
                            </div>
                            <div class="form-group">
                                <label class="control-label"
                                       for="input-date-date_added"><?php echo $entry_date_added; ?></label>
                                <div class="input-group date">
                                    <input type="text" name="filter_date_added"
                                           ...
                                           id="input-date-date_added" class="form-control"/>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                <td class="text-right"><?php if ($sort == 'or.order_recurring_id') { ?>
                                    <a href="<?php echo $sort_order_recurring; ?>"
                                       class="<?php echo strtolower($order); ?>"><?php echo $column_order_recurring_id; ?></a>
                                    <?php } else { ?>
                                ...
                                <td class="text-left"><?php if ($sort == 'or.reference') { ?>
                                    <a href="<?php echo $sort_reference; ?>"
                                       class="<?php echo strtolower($order); ?>"><?php echo $column_reference; ?></a>
                                    <?php } else { ?>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <a href="<?php echo $recurring['view']; ?>" data-toggle="tooltip"
                                       title="<?php echo $button_order_recurring; ?>" class="btn btn-info"><i
                                                class="fa fa-eye"></i></a>
                                    <a href="<?php echo $recurring['order']; ?>" data-toggle="tooltip"
                                       title="<?php echo $button_order; ?>" class="btn btn-info"><i
