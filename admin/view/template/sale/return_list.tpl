        ...
        <div class="container-fluid">
            <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip"
                ...
                <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger"
                        onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-return').submit() : false;"><i
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="control-label"
                                       for="input-return-id"><?php echo $entry_return_id; ?></label>
                                <input type="text" name="filter_return_id" value="<?php echo $filter_return_id; ?>"
                                       placeholder="<?php echo $entry_return_id; ?>" id="input-return-id"
                                       class="form-control"/>
                            </div>
                            <div class="form-group">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="text-right"><?php if ($sort == 'r.return_id') { ?>
                                    <a href="<?php echo $sort_return_id; ?>"
                                       class="<?php echo strtolower($order); ?>"><?php echo $column_return_id; ?></a>
                                    <?php } else { ?>
                                ...
                                <td class="text-left"><?php if ($sort == 'r.product') { ?>
                                    <a href="<?php echo $sort_product; ?>"
                                       class="<?php echo strtolower($order); ?>"><?php echo $column_product; ?></a>
                                    <?php } else { ?>
                            ...
                            <tr>
                                <td class="text-center"><?php if (in_array($return['return_id'], $selected)) { ?>
                                    ...
                                    <input type="checkbox" name="selected[]"
                                           value="<?php echo $return['return_id']; ?>"/>
                                    <?php } ?></td>
                                ...
                                <td class="text-right"><a href="<?php echo $return['edit']; ?>" data-toggle="tooltip"
