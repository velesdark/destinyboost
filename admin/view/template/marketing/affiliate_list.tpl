        ...
        <div class="container-fluid">
            <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip"
                ...
                <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger"
                        onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-affiliate').submit() : false;"><i
                            ...
                            <tr>
                                <td class="text-center"><?php if (in_array($affiliate['affiliate_id'], $selected)) { ?>
                                    <input type="checkbox" name="selected[]"
                                           value="<?php echo $affiliate['affiliate_id']; ?>" checked="checked"/>
                                    <?php } else { ?>
                                    <input type="checkbox" name="selected[]"
                                           value="<?php echo $affiliate['affiliate_id']; ?>"/>
                                    <?php } ?></td>
                                ...
                                <td class="text-right"><?php if ($affiliate['approve']) { ; ?>
                                    <a href="<?php echo $affiliate['approve']; ?>" data-toggle="tooltip"
                                    ...
                                    <a href="<?php echo $affiliate['unlock']; ?>" data-toggle="tooltip"
                                    ...
                                    <?php } ?>
                                    <a href="<?php echo $affiliate['edit']; ?>" data-toggle="tooltip"
