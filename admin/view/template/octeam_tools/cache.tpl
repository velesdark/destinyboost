    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <a data-toggle="tooltip" title="<?php echo $text_title_image; ?>" class="btn btn-danger cache"
                   data-type="image"><i class="fa fa-file-image-o"></i> <?php echo $button_image; ?></a>
                <a data-toggle="tooltip" title="<?php echo $text_title_system; ?>" class="btn btn-danger cache"
                   data-type="system"><i class="fa fa-code"></i> <?php echo $button_system; ?></a>
                <a href="<?php echo $back; ?>" data-toggle="tooltip" title="<?php echo $button_back; ?>"
                   class="btn btn-default"><i class="fa fa-reply"></i> <?php echo $button_back; ?></a></div>
            <br/><br/>
