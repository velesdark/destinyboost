    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="button" class="btn btn-info" onclick="location = '<?php echo $clear; ?>'"
                        data-toggle="tooltip" title="<?php echo $button_clear_cache; ?>"><i class="fa fa-eraser"></i>&nbsp;<?php echo $button_clear_cache; ?>
                </button>
                <button type="button" id="insert" class="btn btn-success" data-toggle="tooltip"
                        title="<?php echo $button_add; ?>"><i
                            class="fa fa-plus-circle"></i>&nbsp;<?php echo $button_add; ?></button>
                <button type="button" id="delete" class="btn btn-danger" data-toggle="tooltip"
                        title="<?php echo $button_delete; ?>"><i
                            class="fa fa-trash"></i>&nbsp;<?php echo $button_delete; ?></button>
                <a href="<?php echo $cancel; ?>" data-toggle="tooltip" title="<?php echo $button_cancel; ?>"
                   class="btn btn-default"><i class="fa fa-reply"></i>&nbsp;<?php echo $button_cancel; ?></a>
            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label"
                                       for="input-filter_query"><?php echo $column_filter_query; ?></label>
                                <input type="text" name="filter_query" value="<?php echo $filter_query; ?>"
                                       placeholder="<?php echo $column_filter_query; ?>" id="input-filter_query"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label"
                                       for="input-filter_keyword"><?php echo $column_filter_keyword; ?></label>
                                <input type="text" name="filter_keyword" value="<?php echo $filter_keyword; ?>"
                                       placeholder="<?php echo $column_filter_keyword; ?>" id="input-filter_keyword"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="query" value="" placeholder="<?php echo $column_query; ?>"
                                       id="input-query" class="form-control"/>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label" for="input-keyword"><?php echo $column_keyword; ?></label>
                                <input type="text" name="keyword" value="" placeholder="<?php echo $column_keyword; ?>"
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label"><?php echo $column_action; ?></label><br/>
                                <button type="button" id="button-save" data-toggle="tooltip"
                                        title="<?php echo $button_save; ?>" class="btn btn-primary"><i
                                            class="fa fa-save"></i></button>&nbsp;
                                <button type="button" id="button-cancel" data-toggle="tooltip"
                                        title="<?php echo $button_cancel; ?>" class="btn btn-danger"><i
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="text-left"><?php if ($sort == 'query') { ?>
                                    <a href="<?php echo $sort_query; ?>"
                                       class="<?php echo strtolower($order); ?>"><?php echo $column_query; ?></a>
                                    <?php } else { ?>
                                    <a href="<?php echo $sort_query; ?>"><?php echo $column_query; ?></a>
                                    <?php } ?></td>
                                <td class="text-right"><?php if ($sort == 'keyword') { ?>
                                    <a href="<?php echo $sort_keyword; ?>"
                                       class="<?php echo strtolower($order); ?>"><?php echo $column_keyword; ?></a>
                                    <?php } else { ?>
                            ...
                            <tr>
                                <td class="text-center"><?php if (in_array($url_alias['url_alias_id'], $selected)) { ?>
                                    <input type="checkbox" name="selected[]"
                                           value="<?php echo $url_alias['url_alias_id']; ?>" checked="checked"/>
                                    <?php } else { ?>
                                    <input type="checkbox" name="selected[]"
                                           value="<?php echo $url_alias['url_alias_id']; ?>"/>
                                    <?php } ?></td>
                                ...
                                <td class="text-right">
                                    <button type="button" onclick="edit(<?php echo $url_alias['url_alias_id']; ?>)"
