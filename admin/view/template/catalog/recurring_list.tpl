        ...
        <div class="container-fluid">
            <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip"
                ...
                <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger"
                        onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-recurring').submit() : false;"><i
                ...
                <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-recurring">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            <thead>
                            <tr>
                                <td class="text-center" width="1"><input type="checkbox"
                            ...
                            <tr>
                                <td class="text-center"><?php if (in_array($recurring['recurring_id'], $selected)) { ?>
                                    <input type="checkbox" name="selected[]"
                                           value="<?php echo $recurring['recurring_id']; ?>" checked="checked"/>
                                    <?php } else { ?>
                                    <input type="checkbox" name="selected[]"
                                           value="<?php echo $recurring['recurring_id']; ?>"/>
                                    <?php } ?></td>
                                <td class="text-left"><?php echo $recurring['name']; ?></td>
                                <td class="text-right"><?php echo $recurring['sort_order']; ?></td>
                                <td class="text-right"><a href="<?php echo $recurring['edit']; ?>" data-toggle="tooltip"
