        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                      id="form-google-analytics" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="google_analytics_code" rows="5" placeholder="<?php echo $entry_code; ?>"
                                      id="input-code"
                                      class="form-control"><?php echo $google_analytics_code; ?></textarea>
                            <?php if ($error_code) { ?>
