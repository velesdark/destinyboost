    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-parcelforce-48" data-toggle="tooltip"
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                      id="form-parcelforce-48" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="parcelforce_48_rate" rows="5" placeholder="<?php echo $entry_rate; ?>"
                                      id="input-rate"
                                      class="form-control"><?php echo $parcelforce_48_rate; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-insurance"><span data-toggle="tooltip"
                                                                                          title="<?php echo $help_insurance; ?>"><?php echo $entry_insurance; ?></span></label>
                        <div class="col-sm-10">
                            <textarea name="parcelforce_48_insurance" rows="5"
                                      placeholder="<?php echo $entry_insurance; ?>" id="input-insurance"
                                      class="form-control"><?php echo $parcelforce_48_insurance; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-display-insurance"><span data-toggle="tooltip"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="parcelforce_48_sort_order"
                                   value="<?php echo $parcelforce_48_sort_order; ?>"
