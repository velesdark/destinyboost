    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-fedex" data-toggle="tooltip" title="<?php echo $button_save; ?>"
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-fedex"
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="fedex_meter" value="<?php echo $fedex_meter; ?>"
                                   placeholder="<?php echo $entry_meter; ?>" id="input-meter" class="form-control"/>
                            <?php if ($error_meter) { ?>
                            ...
                            <div class="well well-sm" style="height: 150px; overflow: auto;">
                                ...
                                <div class="checkbox">
                                    <label>
                                        ...
                                        <input type="checkbox" name="fedex_service[]"
                                               value="<?php echo $service['value']; ?>" checked="checked"/>
                                        <?php echo $service['text']; ?>
                                        <?php } else { ?>
                                        <input type="checkbox" name="fedex_service[]"
                                               value="<?php echo $service['value']; ?>"/>
                                        <?php echo $service['text']; ?>
                                        <?php } ?>
                                    </label>
                                </div>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-sm-4">
                                    <input type="text" name="fedex_length" value="<?php echo $fedex_length; ?>"
                                           placeholder="<?php echo $entry_length; ?>" id="input-length"
                                           class="form-control"/>
                                </div>
                                <div class="col-sm-4">
                                    <input type="text" name="fedex_width" value="<?php echo $fedex_width; ?>"
                                           placeholder="<?php echo $entry_width; ?>" id="input-width"
                                           class="form-control"/>
                                </div>
                                <div class="col-sm-4">
                                    <input type="text" name="fedex_height" value="<?php echo $fedex_height; ?>"
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-dropoff-type"><?php echo $entry_dropoff_type; ?></label>
                        <div class="col-sm-10">
                            <select name="fedex_dropoff_type" id="input-dropoff-type" class="form-control">
                                ...
                                <option value="REGULAR_PICKUP"
                                        selected="selected"><?php echo $text_regular_pickup; ?></option>
                                <?php } else { ?>
                                <option value="REGULAR_PICKUP"><?php echo $text_regular_pickup; ?></option>
                                <?php } ?>
                                <?php if ($fedex_dropoff_type == 'REQUEST_COURIER') { ?>
                                <option value="REQUEST_COURIER"
                                        selected="selected"><?php echo $text_request_courier; ?></option>
                                <?php } else { ?>
                                ...
                                <option value="BUSINESS_SERVICE_CENTER"
                                        selected="selected"><?php echo $text_business_service_center; ?></option>
                                <?php } else { ?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-packaging-type"><?php echo $entry_packaging_type; ?></label>
                        <div class="col-sm-10">
                            <select name="fedex_packaging_type" id="input-packaging-type" class="form-control">
                                ...
                                <option value="FEDEX_ENVELOPE"
                                        selected="selected"><?php echo $text_fedex_envelope; ?></option>
                                <?php } else { ?>
                                ...
                                <option value="FEDEX_10KG_BOX"
                                        selected="selected"><?php echo $text_fedex_10kg_box; ?></option>
                                <?php } else { ?>
                                ...
                                <option value="FEDEX_25KG_BOX"
                                        selected="selected"><?php echo $text_fedex_25kg_box; ?></option>
                                <?php } else { ?>
                                ...
                                <option value="YOUR_PACKAGING"
                                        selected="selected"><?php echo $text_your_packaging; ?></option>
                                <?php } else { ?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-rate-type"><?php echo $entry_rate_type; ?></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><span data-toggle="tooltip"
                                                                    title="<?php echo $help_display_time; ?>"><?php echo $entry_display_time; ?></span></label>
                        <div class="col-sm-10">
                            <label class="radio-inline">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="fedex_sort_order" value="<?php echo $fedex_sort_order; ?>"
