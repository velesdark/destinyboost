            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-auspost"
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="auspost_postcode" value="<?php echo $auspost_postcode; ?>"
                                   placeholder="<?php echo $entry_postcode; ?>" id="input-postcode" class="form-control"
                                   maxlength="4"/>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-standard"><?php echo $entry_standard; ?></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-display-time"><span data-toggle="tooltip"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="auspost_sort_order" value="<?php echo $auspost_sort_order; ?>"
