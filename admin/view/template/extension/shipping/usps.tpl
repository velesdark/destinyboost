    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-usps" data-toggle="tooltip" title="<?php echo $button_save; ?>"
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-usps"
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="usps_user_id" value="<?php echo $usps_user_id; ?>"
                                   placeholder="<?php echo $entry_user_id; ?>" id="input-user-id" class="form-control"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="usps_size" id="input-size" class="form-control">
                                ...
                                <option value="<?php echo $size['value']; ?>"
                                        selected="selected"><?php echo $size['text']; ?></option>
                                <?php } else { ?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-container"><?php echo $entry_container; ?></label>
                        <div class="col-sm-10">
                            <select name="usps_container" id="input-container" class="form-control">
                                <?php foreach ($containers as $container) { ?>
                                <?php if ($container['value'] == $usps_container) { ?>
                                <option value="<?php echo $container['value']; ?>"
                                        selected="selected"><?php echo $container['text']; ?></option>
                                <?php } else { ?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-machinable"><?php echo $entry_machinable; ?></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-sm-4">
                                    <input type="text" name="usps_length" value="<?php echo $usps_length; ?>"
                                           placeholder="<?php echo $entry_length; ?>" id="input-length"
                                           class="form-control"/>
                                </div>
                                <div class="col-sm-4">
                                    <input type="text" name="usps_width" value="<?php echo $usps_width; ?>"
                                           placeholder="<?php echo $entry_width; ?>" id="input-width"
                                           class="form-control"/>
                                </div>
                                <div class="col-sm-4">
                                    <input type="text" name="usps_height" value="<?php echo $usps_height; ?>"
