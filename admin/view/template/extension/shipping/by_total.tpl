    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-by-total" data-toggle="tooltip" title="<?php echo $button_save; ?>"
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-by-total"
                                ...
                                <div class="tab-pane active" id="tab-general">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="by_total_sort_order"
                                                       value="<?php echo $by_total_sort_order; ?>" size="1"/></td>
                                        </tr>
                                    </table>
                                </div>
                                <?php foreach ($geo_zones as $geo_zone) { ?>
                                <div class="tab-pane" id="tab-geo-zone<?php echo $geo_zone['geo_zone_id']; ?>">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td><textarea name="by_total_<?php echo $geo_zone['geo_zone_id']; ?>_rate"
                                                          cols="60" rows="5"
                                                          style="width: 100%;"><?php echo ${'by_total_' . $geo_zone['geo_zone_id'] . '_rate'}; ?></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><?php echo $entry_status; ?></td>
