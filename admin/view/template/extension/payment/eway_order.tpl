...
<table class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <td>
            ...
            <input type="text" name="eway_capture_amount" placeholder="<?php echo $eway_order['uncaptured']; ?>"
                   id="eway-capture-amount" class=""/>
            <a class="button btn btn-primary" id="btn-capture"><?php echo $btn_capture; ?></a>
            <span class="btn btn-primary" id="img-loading-capture" style="display:none;"><i
    ...
    <tr>
        ...
        <td>
            ...
            <input type="text" name="eway_refund_amount" placeholder="<?php echo $eway_order['unrefunded']; ?>"
                   id="eway-refund-amount" class=""/>
            <a class="button btn btn-primary" id="btn-refund"><?php echo $btn_refund; ?></a>
            <span class="btn btn-primary" id="img-loading-refund" style="display:none;"><i
                        class="fa fa-cog fa-spin fa-lg"></i></span>
            <?php } ?>
        </td>
    </tr>
