    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-ocstore-yk" class="btn btn-primary"><i
            ...
            <h1><img src="view/image/payment/ocstore_yk-icon.png" width="26" height="26"> <?php echo $heading_title; ?>
            </h1>
            <ul class="breadcrumb">
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-ocstore-yk"
                      class="form-horizontal">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#tab-general" data-toggle="tab"><i
                                        class="fa fa-power-off"></i> <?php echo $tab_general; ?></a></li>
                        <li><a href="#tab-emails" data-toggle="tab"><i
                                        class="fa fa-envelope-o"></i> <?php echo $tab_emails; ?></a></li>
                        <li><a href="#tab-settings" data-toggle="tab"><i
                                        class="fa fa-wrench"></i> <?php echo $tab_settings; ?></a></li>
                        <li><a href="#tab-log" data-toggle="tab"><i class="fa fa-eye"></i> <?php echo $tab_log; ?></a>
                        </li>
                        <li><a href="#tab-information" data-toggle="tab"><i
                                        class="fa fa-info-circle"></i> <?php echo $tab_information; ?></a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="input-hide_mode"><?php echo $entry_hide_mode; ?></label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="input-order-confirm-status"><?php echo $entry_order_confirm_status; ?></label>
                                <div class="col-sm-10">
                                    <select name="ocstore_yk_order_confirm_status_id" id="input-order-confirm-status"
                                            class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="ocstore_yk_order_status_id" id="input-order-status"
                                            class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="input-order-fail-status"><?php echo $entry_order_fail_status; ?></label>
                                <div class="col-sm-10">
                                    <select name="ocstore_yk_order_fail_status_id" id="input-order-fail-status"
                                            class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="ocstore_yk_laterpay_mode" id="input-laterpay_mode"
                                            class="form-control">
                            ...
                            <div class="form-group" id="laterpay-mode-tr" style="display: none;">
                                <label class="col-sm-2 control-label"
                                       for="input-order-later-status"><?php echo $entry_order_later_status; ?></label>
                                <div class="col-sm-10">
                                    <select name="ocstore_yk_order_later_status_id" id="input-order-later-status"
                                            class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-addon"><img src="<?php echo $language_image; ?>"
                        ...
                        <div class="tab-pane" id="tab-emails">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-addon"><img src="<?php echo $language_image; ?>"
                                                                             title="<?php echo $language['name']; ?>"/></span>
                                        <input type="text"
                                               name="ocstore_yk_langdata[<?php echo $language['language_id']; ?>][mail_customer_success_subject]"
                                  ...
                                  ? $ocstore_yk_langdata[$language['language_id']]['mail_customer_success_subject'] : $sample_mail_customer_success_subject; ?>"
                                               placeholder="<?php echo $entry_mail_customer_success_subject; ?>"
                                               class="form-control"/>
                                    </div>
                                    <?php } ?>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-addon"><img src="<?php echo $language_image; ?>"
                                                                             title="<?php echo $language['name']; ?>"/></span>
                                        <textarea
                                                name="ocstore_yk_langdata[<?php echo $language['language_id']; ?>][mail_customer_success_content]"
                                                rows="5"
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-addon"><img src="<?php echo $language_image; ?>"
                                                                             title="<?php echo $language['name']; ?>"/></span>
                                        <input type="text"
                                               name="ocstore_yk_langdata[<?php echo $language['language_id']; ?>][mail_customer_fail_subject]"
                                  ...
                                  ? $ocstore_yk_langdata[$language['language_id']]['mail_customer_fail_subject'] : $sample_mail_customer_fail_subject; ?>"
                                               placeholder="<?php echo $entry_mail_customer_fail_subject; ?>"
                                               class="form-control"/>
                                    </div>
                                    <?php } ?>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-addon"><img src="<?php echo $language_image; ?>"
                                                                             title="<?php echo $language['name']; ?>"/></span>
                                        <textarea
                                                name="ocstore_yk_langdata[<?php echo $language['language_id']; ?>][mail_customer_fail_content]"
                                                rows="5"
                            ...
                            <div class="form-group required" id="mail-admin-success-tr" style="display: none;">
                                ...
                                <div class="col-sm-8">
                                    <label class="control-label"
                                           for="input-mail-admin-success-subject"><?php echo $entry_mail_admin_success_subject; ?></label>
                                    <input type="text" name="ocstore_yk_mail_admin_success_subject"
                                           id="input-mail-admin-success-subject"
                                ...
                                ? $ocstore_yk_mail_admin_success_subject : $sample_mail_admin_success_subject; ?>"
                                           placeholder="<?php echo $entry_mail_admin_success_subject; ?>"
                                           class="form-control"/>
                            ...
                            <div class="form-group required" id="mail-admin-fail-tr" style="display: none;">
                                ...
                                <div class="col-sm-8">
                                    <label class="control-label"
                                           for="input-mail-admin-fail-subject"><?php echo $entry_mail_admin_fail_subject; ?></label>
                                    <input type="text" name="ocstore_yk_mail_admin_fail_subject"
                                           id="input-mail-admin-fail-subject"
                                           value="<?php echo !empty($ocstore_yk_mail_admin_fail_subject)
                                ? $ocstore_yk_mail_admin_fail_subject : $sample_mail_admin_fail_subject; ?>"
                                           placeholder="<?php echo $entry_mail_admin_fail_subject; ?>"
                                           class="form-control"/>
                        ...
                        <div class="tab-pane" id="tab-settings">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="input-type"><?php echo $entry_type; ?></label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group required" id="wallet-tr" style="display: none;">
                                <label class="col-sm-2 control-label"
                                       for="input-wallet"><?php echo $entry_wallet; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="ocstore_yk_wallet"
                                           value="<?php echo $ocstore_yk_wallet; ?>"
                                           placeholder="<?php echo $entry_wallet; ?>" id="input-wallet"
                                           class="form-control"/>
                            ...
                            <div class="form-group required" id="shop_id-tr" style="display: none;">
                                <label class="col-sm-2 control-label"
                                       for="input-shop_id"><?php echo $entry_shop_id; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="ocstore_yk_shop_id"
                                           value="<?php echo $ocstore_yk_shop_id; ?>"
                                           placeholder="<?php echo $entry_shop_id; ?>" id="input-shop_id"
                                           class="form-control"/>
                            ...
                            <div class="form-group required" id="scid-tr" style="display: none;">
                                <label class="col-sm-2 control-label"
                                       for="input-scid"><?php echo $entry_scid; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="ocstore_yk_scid" value="<?php echo $ocstore_yk_scid; ?>"
                                           placeholder="<?php echo $entry_scid; ?>" id="input-scid"
                                           class="form-control"/>
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label"
                                       for="input-shop_password"><?php echo $entry_shop_password; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="ocstore_yk_shop_password"
                                           value="<?php echo $ocstore_yk_shop_password; ?>"
                                           placeholder="<?php echo $entry_shop_password; ?>" id="input-shop_password"
                                           class="form-control"/>
                            ...
                            <div class="form-group" id="physical_enabled_methods-tr" style="display: none;">
                                <div class="col-sm-12">
                                    <table class="table table-bordered table-hover table-striped">
                                        <thead>
                                        <tr>
                                            <td class="text-left" rowspan="2"><?php echo $entry_enabled_methods; ?>
                                                <div class="help-block"
                                                     style="font-weight:normal;"><?php echo $text_physical_limits; ?></div>
                                            </td>
                                            <td style="vertical-align:top;"
                                                class="text-center"><?php echo $entry_comission; ?>
                                                <div class="help-block"
                                                     style="font-weight:normal;"><?php echo $help_comission; ?></div>
                                            </td>
                                            <td style="vertical-align:top;"
                                                class="text-center"><?php echo $entry_minimal_order; ?>
                                                <div class="help-block"
                                                     style="font-weight:normal;"><?php echo $help_minimal_order; ?></div>
                                            </td>
                                            <td style="vertical-align:top;"
                                                class="text-center"><?php echo $entry_maximal_order; ?>
                                                <div class="help-block"
                                                     style="font-weight:normal;"><?php echo $help_maximal_order; ?></div>
                                            </td>
                                            <td style="vertical-align:top;"
                                                class="text-center"><?php echo $entry_sort_order; ?>
                                                <div class="help-block"
                                                     style="font-weight:normal;"><?php echo $help_sort_order; ?></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="vertical-align:top;"
                                                class="text-center"><?php echo $entry_description; ?>
                                                <div class="help-block"
                                                     style="font-weight:normal;"><?php echo $help_description; ?></div>
                                            </td>
                                            <td style="vertical-align:top;"
                                                class="text-center"><?php echo $entry_title; ?>
                                                <div class="help-block"
                                                     style="font-weight:normal;"><?php echo $help_title; ?></div>
                                            </td>
                                            <td style="vertical-align:top;"
                                                class="text-center"><?php echo $entry_button_confirm; ?>
                                                <div class="help-block"
                                                     style="font-weight:normal;"><?php echo $help_button_confirm; ?></div>
                                            </td>
                                            <td style="vertical-align:top;"
                                                class="text-center"><?php echo $entry_geo_zone; ?></td>
                                        </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <td class="text-left" rowspan="2">
                                                <label class="radio-inline">
                                                    <input type="checkbox" class="status"
                                                           name="ocstore_yk_physical_enabled_methods[<?php echo $key; ?>]"
                                                           value="<?php echo $value; ?>" <?php echo in_array($value, $ocstore_yk_physical_enabled_methods) ? 'checked="checked"' : ''?>
                                                    /> - <?php echo $value; ?>
                                                    <input type="hidden"
                                                           name="ocstore_yk_physical_<?php echo $key; ?>_status"
                                                           value="<?php echo (int)in_array($value, $ocstore_yk_physical_enabled_methods); ?>"/>
                                                </label>
                                            </td>
                                            <td class="text-center">
                                                <input type="text"
                                                       name="ocstore_yk_physical_<?php echo $key; ?>_comission"
                                                       value="<?php echo ${'ocstore_yk_physical_' . $key . '_comission'}; ?>"
                                                       size="3"/>&nbsp;%
                                            </td>
                                            <td class="text-center">
                                                <input type="text"
                                                       name="ocstore_yk_physical_<?php echo $key; ?>_minimal_order"
                                                       value="<?php echo ${'ocstore_yk_physical_' . $key . '_minimal_order'}; ?>"
                                                       size="8"/>&nbsp;<?php echo $backend_currency; ?>
                                            </td>
                                            <td class="text-center">
                                                <input type="text"
                                                       name="ocstore_yk_physical_<?php echo $key; ?>_maximal_order"
                                                       value="<?php echo ${'ocstore_yk_physical_' . $key . '_maximal_order'}; ?>"
                                                       size="8"/>&nbsp;<?php echo $backend_currency; ?>
                                            </td>
                                            <td class="text-center">
                                                <input type="text"
                                                       name="ocstore_yk_physical_<?php echo $key; ?>_sort_order"
                                                       value="<?php echo ${'ocstore_yk_physical_' . $key . '_sort_order'}; ?>"
                                                       size="3"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text-center">
                                                <label style="cursor:pointer; font-weight:normal"><input type="radio"
                                                                                                         name="ocstore_yk_physical_<?php echo $key; ?>_description"
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-addon"><img
                                                                src="<?php echo $language_image; ?>"
                                                                title="<?php echo $language['name']; ?>"/></span>
                                                    <input type="text"
                                                           name="ocstore_yk_physical_<?php echo $key; ?>_langdata[<?php echo $language['language_id']; ?>][title]"
                                                           class="form-control"
                                                           value="<?php echo !empty(${'ocstore_yk_physical_' . $key . '_langdata'}[$language['language_id']]['title'])
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-addon"><img
                                                                ...
                                                                title="<?php echo $language['name']; ?>"/></span>
                                                    <input type="text"
                                                           name="ocstore_yk_physical_<?php echo $key; ?>_langdata[<?php echo $language['language_id']; ?>][button_confirm]"
                                                           class="form-control"
                                                           value="<?php echo !empty(${'ocstore_yk_physical_' . $key . '_langdata'}[$language['language_id']]['button_confirm'])
                                                    ? ${'ocstore_yk_physical_' . $key . '_langdata'}[$language['language_id']]['button_confirm'] : $sample_button_confirm; ?>"/>
                                                </div>
                                                <?php } ?>
                                            </td>
                                            <td class="text-center">
                                                <select name="ocstore_yk_physical_<?php echo $key; ?>_geo_zone_id"
                                                        class="form-control">
                                                    <option value="0"><?php echo $text_all_zones; ?></option>
                                                    <?php foreach ($geo_zones as $geo_zone) { ?>
                                                    <option value="<?php echo $geo_zone['geo_zone_id']; ?>"
                                                    <?php echo $geo_zone['geo_zone_id'] == ${'ocstore_yk_physical_' . $key . '_geo_zone_id'} ?
                                ...
                                <div class="col-sm-12">
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tr>
                                            <td class="text-left" rowspan="2"><?php echo $entry_enabled_methods; ?>
                                                <div class="help-block"
                                                     style="font-weight:normal;"><?php echo $text_company_limits; ?></div>
                                            </td>
                                            <td style="vertical-align:top;"
                                                class="text-center"><?php echo $entry_comission; ?>
                                                <div class="help-block"
                                        ...
                                        <tr>
                                            <td class="text-left" rowspan="2">
                                                <label class="radio-inline">
                                                    <input type="checkbox" class="status"
                                                           name="ocstore_yk_company_enabled_methods[<?php echo $key; ?>]"
                                                           value="<?php echo $value; ?>" <?php echo in_array($value, $ocstore_yk_company_enabled_methods) ? 'checked="checked"' : ''?>
                                                    /> - <?php echo $value; ?>
                                                    <input type="hidden"
                                                           name="ocstore_yk_company_<?php echo $key; ?>_status"
                                                           value="<?php echo (int)in_array($value, $ocstore_yk_company_enabled_methods); ?>"/>
                                                </label>
                                            </td>
                                            <td class="text-center">
                                                <input type="text"
                                                       name="ocstore_yk_company_<?php echo $key; ?>_comission"
                                                       value="<?php echo ${'ocstore_yk_company_' . $key . '_comission'}; ?>"
                                                       size="3"/>&nbsp;%
                                            </td>
                                            <td class="text-center">
                                                <input type="text"
                                                       name="ocstore_yk_company_<?php echo $key; ?>_minimal_order"
                                                       value="<?php echo ${'ocstore_yk_company_' . $key . '_minimal_order'}; ?>"
                                                       size="8"/>&nbsp;<?php echo $backend_currency; ?>
                                            </td>
                                            <td class="text-center">
                                                <input type="text"
                                                       name="ocstore_yk_company_<?php echo $key; ?>_maximal_order"
                                                       value="<?php echo ${'ocstore_yk_company_' . $key . '_maximal_order'}; ?>"
                                                       size="8"/>&nbsp;<?php echo $backend_currency; ?>
                                            </td>
                                            <td class="text-center">
                                                <input type="text"
                                                       name="ocstore_yk_company_<?php echo $key; ?>_sort_order"
                                                       value="<?php echo ${'ocstore_yk_company_' . $key . '_sort_order'}; ?>"
                                                       size="3"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text-center">
                                                <label style="cursor:pointer; font-weight:normal"><input type="radio"
                                                                                                         name="ocstore_yk_company_<?php echo $key; ?>_description"
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-addon"><img
                                                                ...
                                                                title="<?php echo $language['name']; ?>"/></span>
                                                    <input type="text"
                                                           name="ocstore_yk_company_<?php echo $key; ?>_langdata[<?php echo $language['language_id']; ?>][title]"
                                                           class="form-control"
                                                           value="<?php echo !empty(${'ocstore_yk_company_' . $key . '_langdata'}[$language['language_id']]['title'])
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-addon"><img
                                                                ...
                                                                title="<?php echo $language['name']; ?>"/></span>
                                                    <input type="text"
                                                           name="ocstore_yk_company_<?php echo $key; ?>_langdata[<?php echo $language['language_id']; ?>][button_confirm]"
                                                           class="form-control"
                                                           value="<?php echo !empty(${'ocstore_yk_company_' . $key . '_langdata'}[$language['language_id']]['button_confirm'])
                                                    ? ${'ocstore_yk_company_' . $key . '_langdata'}[$language['language_id']]['button_confirm'] : $sample_button_confirm; ?>"/>
                                                </div>
                                                <?php } ?>
                                            </td>
                                            <td class="text-center">
                                                <select name="ocstore_yk_company_<?php echo $key; ?>_geo_zone_id"
                                                        class="form-control">
                                                    <option value="0"><?php echo $text_all_zones; ?></option>
                                                    <?php foreach ($geo_zones as $geo_zone) { ?>
                                                    <option value="<?php echo $geo_zone['geo_zone_id']; ?>"
                                                    <?php echo $geo_zone['geo_zone_id'] == ${'ocstore_yk_company_' . $key . '_geo_zone_id'} ?
                                          ' selected="selected"' : ''; ?>><?php echo $geo_zone['name']; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </td>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="input-test-mode"><?php echo $entry_test_mode; ?></label>
                                <div class="col-sm-10">
                                    ...
                                    <span class="help-block" id="help-test-mode-company"
                                          style="display: none;"><?php echo $help_test_mode_company; ?></span>
                                    <span class="help-block" id="help-test-mode-physical"
                                          style="display: none;"><?php echo $help_test_mode_physical; ?></span>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab-log">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="hidden" name="ocstore_yk_log_filename"
                                           value="<?php echo $log_filename ?>"/>
                                ...
                                <div class="col-sm-2">
                                    <a class="btn btn-danger" id="button-clear"><i
                                                class="fa fa-eraser"></i> <?php echo $button_clear; ?></a>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="well well-sm" style="height: 300px; overflow: auto;">
                                        <pre id="pre-log"
                                             style="font-size:11px; min-height: 280px;"><?php foreach ($log_lines as $log_line) {echo htmlentities($log_line, ENT_NOQUOTES, 'UTF-8');} ?></pre>
                                    </div>
                        ...
                        <div class="tab-pane" id="tab-information">
                            ...
                            <div class="alert alert-success" style="padding: 30px 10px;"><i
                                        class="fa fa-check-circle"></i></div>
                            <textarea style="display: none;"
                                      id="info-physical"><?php echo $text_info_physical; ?></textarea>
                            <textarea style="display: none;"
                                      id="info-company"><?php echo $text_info_company; ?></textarea>
                            <div class="help" style="display:none; padding:10px; color:#f00000; text-align:center;"
                                 id="ssl-info"><?php echo $text_ssl; ?></div>
...
<script type="text/javascript"><!--
    ...
    <
            ? php foreach($oc_languages as $language)
        {
                ?
        >
            ckeditorInit('mail-customer-success-content<?php echo $language['
            language_id
            ']; ?>', getURLVar('token')
        )
            ;
            ckeditorInit('mail-customer-fail-content<?php echo $language['
            language_id
            ']; ?>', getURLVar('token')
        )
            ;
