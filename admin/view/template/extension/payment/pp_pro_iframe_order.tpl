...
<table class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <td><?php echo $paypal_order['total']; ?>
            ...
            &nbsp;&nbsp; <a onclick="doVoid();" id="button-void"
                            class="button paypal_capture btn btn-primary"><?php echo $button_void; ?></a> <span
    ...
    <tr class="paypal_capture">
        ...
        <td><p>
            ...
            <p>
                <input type="text" size="10" id="paypal_capture_amount"
                       value="<?php echo $paypal_order['remaining']; ?>"/>
                <a class="btn btn-primary" onclick="capture();" id="button-capture"><?php echo $button_capture; ?></a>
                <span class="btn btn-primary" id="img_loading_capture" style="display:none;"><i
                            class="fa fa-circle-o-notch fa-spin fa-lg"></i></span></p></td>
    </tr>
    <?php } ?>
    <?php if ($paypal_order['capture_status'] != 'Complete') { ?>
    <tr>
        <td><?php echo $text_reauthorise; ?></td>
        <td><a id="button-reauthorise" onclick="reauthorise()"
               class="btn btn-primary"><?php echo $button_reauthorise; ?></a></td>
    </tr>
    <?php } ?>
    <tr>
            ...
            <table class="table table-striped table-bordered" id="paypal_transactions">
                ...
                <tr>
                    ...
                    <td class="text-left"><?php if ($transaction['transaction_id']) { ?>
                        ...
                        <?php } ?>
                        <?php } else { ?>
                        <a onclick="resendTransaction(this); return false;"
                           href="<?php echo $transaction['resend']; ?>"><?php echo $text_resend; ?></a>
                        <?php } ?></td>
                </tr>
                <?php } ?>
                </tbody>
