    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-klarna-checkout" data-toggle="tooltip"
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                      id="form-klarna-checkout" class="form-horizontal">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-setting">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="klarna_checkout_total"
                                           value="<?php echo $klarna_checkout_total; ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="klarna_checkout_order_status_id" id="input-order-status"
                                            class="form-control">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="input-terms"><?php echo $entry_terms; ?></label>
                                <div class="col-sm-10">
                        ...
                        <div class="tab-pane" id="tab-account">
                            ...
                            <div class="alert alert-danger"><i
                                        class="fa fa-exclamation-circle"></i> <?php echo $error_account_warning; ?>
                            </div>
                            <?php } ?>
                            <table id="account" class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="text-left required"><span data-toggle="tooltip"
                                                                         title="<?php echo $help_locale; ?>"><?php echo $entry_locale; ?></span>
                                    </td>
                                    <td class="text-left required"><span data-toggle="tooltip"
                                                                         title="<?php echo $help_api; ?>"><?php echo $entry_api; ?></span>
                                    </td>
                                    <td></td>
                                </tr>
                                </thead>
                                ...
                                <tr id="account-row<?php echo $account_row; ?>">
                                    <td class="text-left">
                                        <input type="text"
                                               name="klarna_checkout_account[<?php echo $account_row; ?>][merchant_id]"
                                               placeholder="<?php echo $entry_merchant_id; ?>" class="form-control"
                                               value="<?php echo $account['merchant_id']; ?>"/>
                                    ...
                                    <td class="text-left">
                                        <input type="text"
                                               name="klarna_checkout_account[<?php echo $account_row; ?>][secret]"
                                               placeholder="<?php echo $entry_merchant_id; ?>" class="form-control"
                                               value="<?php echo $account['secret']; ?>"/>
                                        <?php if (isset($error_account[$key]['secret'])) { ?>
                                        <div class="text-danger"><?php echo $error_account[$key]['secret']; ?></div>
                                        <?php } ?>
                                    </td>
                                    <td class="text-left">
                                        <select name="klarna_checkout_account[<?php echo $account_row; ?>][environment]"
                                                class="form-control">
                                    ...
                                    <td class="text-left">
                                        <select name="klarna_checkout_account[<?php echo $account_row; ?>][country]"
                                                class="form-control">
                                    ...
                                    <td class="text-left">
                                        <select name="klarna_checkout_account[<?php echo $account_row; ?>][currency]"
                                                class="form-control">
                                    ...
                                    <td class="text-left">
                                        <input type="text"
                                               name="klarna_checkout_account[<?php echo $account_row; ?>][locale]"
                                               placeholder="<?php echo $entry_locale; ?>" class="form-control"
                                               value="<?php echo $account['locale']; ?>"/>
                                        <?php if (isset($error_account[$key]['locale'])) { ?>
                                        <div class="text-danger"><?php echo $error_account[$key]['locale']; ?></div>
                                        <?php } ?>
                                    </td>
                                    <td class="text-left">
                                        <select name="klarna_checkout_account[<?php echo $account_row; ?>][api]"
                                                class="form-control klarna-checkout-api">
                                            <?php foreach ($api_locations as $api_location) { ?>
                                            <?php if ($api_location['code'] == $account['api']) { ?>
                                            <option value="<?php echo $api_location['code']; ?>"
                                                    selected="selected"><?php echo $api_location['name']; ?></option>
                                            <?php } else { ?>
                                    ...
                                    <td class="text-left">
                                        <button type="button"
                                                onclick="$('#account-row<?php echo $account_row; ?>').remove();"
                                                data-toggle="tooltip" title="<?php echo $button_account_remove; ?>"
                                ...
                                <tr>
                                    <td colspan="7"></td>
                                    <td class="text-left">
                                        <button type="button" onclick="addAccount();" data-toggle="tooltip"
                        ...
                        <div class="tab-pane" id="tab-settlement">
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-sftp-username"><span
                                            data-toggle="tooltip"
                                            title="<?php echo $help_sftp_username; ?>"><?php echo $entry_sftp_username; ?></span></label>
                                <div class="col-sm-10">
                                    <input type="text" name="klarna_checkout_sftp_username"
                                           placeholder="<?php echo $entry_sftp_username; ?>" class="form-control"
                                           value="<?php echo $klarna_checkout_sftp_username; ?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-sftp-password"><span
                                            data-toggle="tooltip"
                                            title="<?php echo $help_sftp_password; ?>"><?php echo $entry_sftp_password; ?></span></label>
                                <div class="col-sm-10">
                                    <input type="text" name="klarna_checkout_sftp_password"
                                           placeholder="<?php echo $entry_sftp_password; ?>" class="form-control"
                                           value="<?php echo $klarna_checkout_sftp_password; ?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-settlement-order-status"><span
                                            data-toggle="tooltip"
                                            title="<?php echo $help_settlement_order_status; ?>"><?php echo $entry_settlement_order_status; ?></span></label>
                                <div class="col-sm-10">
                                    <select name="klarna_checkout_settlement_order_status_id"
                                            id="input-settlement-order-status" class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="button" id="button-process-settlement"
                                            title="<?php echo $button_process_settlement; ?>"
                                            class="btn btn-primary"><?php echo $button_process_settlement; ?></button>
                                </div>
                            </div>
...
<script type="text/javascript"><!--
    ...
    <
        ? php
    if (empty($klarna_checkout_account)) {
            ?
    >
    ...
    <
            ? php foreach($countries as $country)
        {
                ?
        >
            html += '    <option value="<?php echo $country['
            country_id
            ']; ?>"><?php echo addslashes($country['
            name
            ']); ?></option>';
        <
                ? php
    ...
    <
            ? php foreach($currencies as $currency)
        {
                ?
        >
            html += '    <option value="<?php echo $currency['
            code
            ']; ?>"><?php echo $currency['
            title
            ']; ?></option>';
    ...
    <
            ? php foreach($api_locations as $api_location)
        {
                ?
        >
            html += '    <option value="<?php echo $api_location['
            code
            ']; ?>"><?php echo $api_location['
            name
            ']; ?></option>';
        <
                ? php
