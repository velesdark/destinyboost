...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-amazon-login-pay" data-toggle="tooltip"
    ...
    <div class="container-fluid">
        ...
        <div class="alert alert-info">
            <form method="POST" target="_blank" action="<?php echo $registration_url; ?>" class="form-horizontal"
            ...
            <div id="container-credentials">
                <div class="col-sm-5">
                    <textarea class="form-control" id="input-credentials" placeholder="<?php echo $text_credentials; ?>"
                              rows="7" name="credentials"></textarea>
                </div>
                <div class="col-sm-5">
                    <button id="button-credentials" class="btn btn-primary"
                            type="button"><?php echo $text_validate_credentials; ?></button>
                </div>
            </div>
        </div>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                      id="form-amazon-login-pay" class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="amazon-login-pay-payment-region"><?php echo $entry_payment_region; ?></label>
                        <div class="col-sm-10">
                            <select name="amazon_login_pay_payment_region" id="amazon-login-pay-payment_region"
                                    class="form-control">
                                ...
                                <option value="<?php echo $payment_region_code; ?>"
                                        selected="selected"><?php echo $payment_region_name; ?></option>
                                <?php } else { ?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="amazon-login-pay-language"><?php echo $entry_language; ?></label>
                        <div class="col-sm-10">
                            <select name="amazon_login_pay_language" id="amazon-login-pay-language"
                                    class="form-control">
                                ...
                                <option value="<?php echo $language_code; ?>"
                                        selected="selected"><?php echo $language_name; ?></option>
                                <?php } else { ?>
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label"
                               for="amazon-login-pay-merchant-id"><?php echo $entry_merchant_id; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="amazon_login_pay_merchant_id"
                                   value="<?php echo $amazon_login_pay_merchant_id; ?>"
                                   placeholder="<?php echo $entry_merchant_id; ?>" id="amazon-login-pay-merchant-id"
                                   class="form-control"/>
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label"
                               for="amazon-login-pay-access-key"><?php echo $entry_access_key; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="amazon_login_pay_access_key"
                                   value="<?php echo $amazon_login_pay_access_key; ?>"
                                   placeholder="<?php echo $entry_access_key; ?>" id="amazon-login-pay-access-key"
                                   class="form-control"/>
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label"
                               for="amazon-login-pay-access-secret"><?php echo $entry_access_secret; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="amazon_login_pay_access_secret"
                                   value="<?php echo $amazon_login_pay_access_secret; ?>"
                                   placeholder="<?php echo $entry_access_secret; ?>" id="amazon-login-pay-access-secret"
                                   class="form-control"/>
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label"
                               for="amazon-login-pay-client-id"><?php echo $entry_client_id; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="amazon_login_pay_client_id"
                                   value="<?php echo $amazon_login_pay_client_id; ?>"
                                   placeholder="<?php echo $entry_client_id; ?>" id="amazon-login-pay-client-id"
                                   class="form-control"/>
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label"
                               for="amazon-login-pay-client-secret"><?php echo $entry_client_secret; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="amazon_login_pay_client_secret"
                                   value="<?php echo $amazon_login_pay_client_secret; ?>"
                                   placeholder="<?php echo $entry_client_secret; ?>" id="amazon-login-pay-client-secret"
                                   class="form-control"/>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="amazon-login-pay-test"><?php echo $entry_login_pay_test; ?></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="amazon-login-pay-mode"><span data-toggle="tooltip"
                                                                                                title="<?php echo $help_pay_mode; ?>"><?php echo $entry_login_pay_mode; ?></span></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="amazon-login-pay-checkout"><span
                                    data-toggle="tooltip"
                                    title="<?php echo $help_checkout; ?>"><?php echo $entry_checkout; ?></span></label>
                        <div class="col-sm-10">
                            <select name="amazon_login_pay_checkout" id="amazon-login-checkout-mode"
                                    class="form-control">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="amazon-login-pay-capture-status"><span
                                    data-toggle="tooltip"
                                    title="<?php echo $help_capture_status; ?>"><?php echo $entry_capture_status; ?></span></label>
                        <div class="col-sm-10">
                            <select name="amazon_login_pay_capture_status" id="amazon-login-pay-capturet-status"
                                    class="form-control">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="amazon-login-pay-pending-status"><?php echo $entry_pending_status; ?></label>
                        <div class="col-sm-10">
                            <select name="amazon_login_pay_pending_status" id="amazon-login-pay-pendingt-status"
                                    class="form-control">
                                <?php foreach ($order_statuses as $order_status) { ?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-ipn-token"><span data-toggle="tooltip"
                                                                                          title="<?php echo $help_ipn_token; ?>"><?php echo $entry_ipn_token; ?></span></label>
                        <div class="col-sm-10">
                            <input type="text" name="amazon_login_pay_ipn_token"
                                   value="<?php echo $amazon_login_pay_ipn_token; ?>" id="input-ipn-token"
                                   class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group"><span class="input-group-addon"><i class="fa fa-link"></i></span>
                                <input type="text" readonly value="<?php echo $ipn_url; ?>" id="input-ipn-url"
                                       class="form-control"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="amazon-login-pay-minimum-total"><span
                                    data-toggle="tooltip"
                                    title="<?php echo $help_minimum_total; ?>"><?php echo $text_minimum_total; ?></span></label>
                        <div class="col-sm-10">
                            <input type="text" name="amazon_login_pay_minimum_total"
                                   value="<?php echo $amazon_login_pay_minimum_total; ?>"
                                   placeholder="<?php echo $text_minimum_total; ?>" id="amazon-login-pay-minimum-total"
                                   class="form-control"/>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="amazon-login-pay-geo-zone"><?php echo $text_geo_zone; ?></label>
                        <div class="col-sm-10">
                            <select name="amazon_login_pay_geo_zone" id="amazon-login-pay-geo-zone"
                                    class="form-control">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="amazon-login-pay-input-debug"><span
                                    data-toggle="tooltip"
                                    title="<?php echo $help_debug; ?>"><?php echo $entry_debug; ?></span></label>
                        <div class="col-sm-10">
                            <select name="amazon_login_pay_debug" id="amazon-login-pay-input-debug"
                                    class="form-control">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="amazon-login-pay-sort-order"><?php echo $text_sort_order; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="amazon_login_pay_sort_order"
                                   value="<?php echo $amazon_login_pay_sort_order; ?>"
                                   placeholder="<?php echo $text_sort_order; ?>" id="amazon-login-pay-sort-order"
                                   class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="amazon-login-pay-status"><?php echo $text_status; ?></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="amazon-login-pay-declined_codes"><span
                                    data-toggle="tooltip"
                                    title="<?php echo $help_declined_codes; ?>"><?php echo $text_declined_codes; ?></span></label>
                        <div class="col-sm-10">
                            <select name="amazon_login_pay_declined_code" id="amazon-login-pay-declined_code"
                                    class="form-control">
                                ...
                                <option value="<?php echo $declined_code; ?>"
                                        selected="selected"><?php echo $declined_code; ?></option>
                                <?php } else { ?>
