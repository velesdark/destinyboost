...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right"><a href="<?php echo $cancel; ?>" class="btn btn-danger"><i
                            class="fa fa-times"></i> <?php echo $button_cancel; ?></a></div>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td><input type="text" value="0.00" name="amount"/>
                            <a class="btn btn-primary" onclick="refund()"
                               id="button-refund"><?php echo $button_refund; ?></a></td>
                    </tr>
                </table>
            </div>
        </div>
