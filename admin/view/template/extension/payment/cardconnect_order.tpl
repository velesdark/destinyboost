...
<table class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <td><a class="button btn btn-primary btn-xs" id="button-inquire-all"><?php echo $button_inquire_all; ?></a>
            <span class="btn btn-primary btn-xs img_loading_inquire" style="display:none"><i
                        class="fa fa-circle-o-notch fa-spin fa-lg"></i></span></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" style="width:80px" id="capture_amount"
                   value="<?php echo $cardconnect_order['total']; ?>"/>
            <a class="button btn btn-primary btn-sm" id="button-capture"><?php echo $button_capture; ?></a> <span
                    class="btn btn-primary btn-sm" id="img_loading_capture" style="display:none"><i
    ...
    <tr>
        ...
        <td>
            <input type="text" style="width:80px"
                   id="refund_amount" <?php if ($cardconnect_order['total_captured'] < 1) { echo 'style="display:none"'; } ?>
            />
            <a class="button btn btn-primary btn-sm"
               id="button-refund" <?php if ($cardconnect_order['total_captured'] < 1) { echo 'style="display:none"'; } ?>
            ><?php echo $button_refund; ?></a> <span class="btn btn-primary btn-sm" id="img_loading_refund"
    ...
    <tr>
        ...
        <td><a class="button btn btn-primary btn-xs" id="button-void-all"><?php echo $button_void_all; ?></a> <span
                    class="btn btn-primary btn-xs" id="img_loading_void" style="display:none"><i
                        class="fa fa-circle-o-notch fa-spin fa-lg"></i></span></td>
    </tr>
    <tr>
        ...
        <td>
            <table class="table table-striped table-bordered" id="cardconnect_transactions">
                ...
                <tr>
                    ...
                    <td class="text-left"><a class="button btn btn-primary button-inquire btn-xs"
                                             data-inquire-retref="<?php echo $transaction['retref']; ?>"><?php echo $button_inquire; ?></a>
                        <span class="btn btn-primary btn-xs img_loading_inquire" style="display:none"><i
                                    class="fa fa-circle-o-notch fa-spin fa-lg"></i></span></td>
                    <td class="text-left"><a class="button btn btn-primary button-void btn-xs"
                                             data-void-retref="<?php echo $transaction['retref']; ?>"><?php echo $button_void; ?></a>
                        <span class="btn btn-primary btn-xs img_loading_void" style="display:none"><i
                                    class="fa fa-circle-o-notch fa-spin fa-lg"></i></span></td>
                </tr>
                <?php } ?>
                </tbody>
