    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-bluepay-hosted" class="btn btn-primary"><i
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                      id="form-bluepay-hosted" class="form-horizontal">
                    <div class="form-group required">
                        <label class="col-sm-2 control-label"
                               for="input-account-name"><?php echo $entry_account_name; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="bluepay_hosted_account_name"
                                   value="<?php echo $bluepay_hosted_account_name; ?>"
                                   placeholder="<?php echo $entry_account_name; ?>" id="input-account-name"
                                   class="form-control"/>
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label"
                               for="input-account-id"><?php echo $entry_account_id; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="bluepay_hosted_account_id"
                                   value="<?php echo $bluepay_hosted_account_id; ?>"
                                   placeholder="<?php echo $entry_account_id; ?>" id="input-account-id"
                                   class="form-control"/>
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label"
                               for="bluepay_hosted_secret_key"><?php echo $entry_secret_key; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="bluepay_hosted_secret_key"
                                   value="<?php echo $bluepay_hosted_secret_key; ?>"
                                   placeholder="<?php echo $entry_secret_key; ?>" id="bluepay_hosted_secret_key"
                                   class="form-control"/>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-discover"><?php echo $entry_card_discover; ?></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="bluepay_hosted_total" value="<?php echo $bluepay_hosted_total; ?>"
