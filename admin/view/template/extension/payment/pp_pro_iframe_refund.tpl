...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right"><a href="<?php echo $cancel; ?>" class="btn btn-primary"><i
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="transaction_id" value="<?php echo $transaction_id; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="checkbox" name="refund_full" id="refund_full"
                                   value="1" <?php echo ($refund_available == '' ? 'checked="checked"' : ''); ?>
                            onchange="refundAmount();"/>
                        </div>
                    </div>
                    <div class="form-group"
                    <?php echo ($refund_available == '' ? 'style="display:none;" ' : ''); ?>id="partial_amount_row">
                    <label class="col-sm-2 control-label"><?php echo $entry_amount; ?></label>
                    <div class="col-sm-10">
                        <input type="text" name="amount"
                               value="<?php echo ($refund_available != '' ? $refund_available : ''); ?>"
                               placeholder="<?php echo $entry_amount; ?>" class="form-control"/>
                    </div>
            </div>
            <div class="form-group">
            ...
            <div class="pull-right"><a onclick="$('#form').submit();"
                                       class="btn btn-primary"><?php echo $button_refund; ?></a></div>
            </form>
        </div>
    </div>
</div>
