    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-pp-pro-iframe-uk" data-toggle="tooltip"
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                      id="form-pp-pro-iframe-uk" class="form-horizontal">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="pp_pro_iframe_user"
                                           value="<?php echo $pp_pro_iframe_user; ?>"
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="pp_pro_iframe_password"
                                           value="<?php echo $pp_pro_iframe_password; ?>"
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="pp_pro_iframe_sig"
                                           value="<?php echo $pp_pro_iframe_sig; ?>"
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="input-trans-method"><?php echo $entry_transaction_method; ?></label>
                                <div class="col-sm-10">
                                    <select name="pp_pro_iframe_transaction_method" id="input-trans-method"
                                            class="form-control">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-checkout-method"><span
                                            data-toggle="tooltip"
                                            title="<?php echo $help_checkout_method; ?>"><?php echo $entry_checkout_method; ?></span></label>
                                <div class="col-sm-10">
                                    <select name="pp_pro_iframe_checkout_method" id="input-checkout-method"
                                            class="form-control">
                                        ...
                                        <option value="redirect"
                                                selected="selected"><?php echo $text_redirect; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="pp_pro_iframe_total"
                                           value="<?php echo $pp_pro_iframe_total; ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="pp_pro_iframe_sort_order"
                                           value="<?php echo $pp_pro_iframe_sort_order; ?>"
