...
<div id="content">
    ...
    <div class="page-header">
        <div class="container-fluid">
            ...
            <h1><img src="view/image/payment/oplata.png"
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form"
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="oplata_merchant" value="<?php echo $oplata_merchant; ?>"
                                   class="form-control"/>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="oplata_secretkey" value="<?php echo $oplata_secretkey; ?>"
                                   class="form-control"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="oplata_currency" class="form-control">
                                ...
                                <option value="<?php echo $oplata_currenc; ?>"
                                        selected="selected"><?php echo $oplata_currenc; ?></option>
                                <?php } else { ?>
                    ...
                    <div class="form-group ">
                        <label class="col-sm-2 control-label"><span data-toggle="tooltip"
                                                                    title="<?php echo $entry_help_lang; ?>"> <?php echo $entry_language; ?></span></label>
                        <div class="col-sm-10">
                            <input type="text" name="oplata_language" value="<?php echo ($oplata_language == "") ? "RU"
                            : $oplata_language; ?>" class="form-control"/>
                        </div>
                    </div>
                ...
                ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="oplata_sort_order" value="<?php echo $oplata_sort_order; ?>"
                                   size="100" class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-sort-order"><?php echo $entry_styles; ?></label>
                        <div class="col-sm-10">
                            <textarea name="oplata_styles" rows="15" placeholder="Styles" placeholder="Chekout Styles"
                                      class="form-control"><?php echo isset($oplata_styles) ? $oplata_styles : ''; ?></textarea>
                        </div>
                    </div>
                </form>
            </div>
