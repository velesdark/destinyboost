        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                      id="form-authorizenet-sim" class="form-horizontal">
                    <div class="form-group required">
                        <label class="col-sm-2 control-label"
                               for="input-merchant"><?php echo $entry_merchant; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="authorizenet_sim_merchant"
                                   value="<?php echo $authorizenet_sim_merchant; ?>"
                                   placeholder="<?php echo $entry_merchant; ?>" id="input-merchant"
                                   class="form-control"/>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-callback"><span data-toggle="tooltip"
                                                                                         data-html="true"
                                                                                         data-trigger="click"
                                                                                         title="<?php echo htmlspecialchars($help_callback); ?>"><?php echo $entry_callback; ?></span></label>
                        <div class="col-sm-10">
                            <textarea rows="5" readonly id="input-callback"
                                      class="form-control"><?php echo $callback; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-md5"><span data-toggle="tooltip"
                                                                                    data-html="true"
                                                                                    data-trigger="click"
                                                                                    title="<?php echo htmlspecialchars($help_md5); ?>"><?php echo $entry_md5; ?></span></label>
                        <div class="col-sm-10">
                            <input type="text" name="authorizenet_sim_md5" value="<?php echo $authorizenet_sim_md5; ?>"
                                   placeholder="<?php echo $entry_md5; ?>" id="input-md5" class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="authorizenet_sim_total"
                                   value="<?php echo $authorizenet_sim_total; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="authorizenet_sim_order_status_id" id="input-order-status"
                                    class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="authorizenet_sim_sort_order"
                                   value="<?php echo $authorizenet_sim_sort_order; ?>"
