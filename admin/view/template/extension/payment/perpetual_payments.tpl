    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-perpetual-payments" data-toggle="tooltip"
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                      id="form-perpetual-payments" class="form-horizontal">
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-auth-id"><?php echo $entry_auth_id; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="perpetual_payments_auth_id"
                                   value="<?php echo $perpetual_payments_auth_id; ?>"
                                   placeholder="<?php echo $entry_auth_id; ?>" id="input-auth-id" class="form-control"/>
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label"
                               for="input-auth-pass"><?php echo $entry_auth_pass; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="perpetual_payments_auth_pass"
                                   value="<?php echo $perpetual_payments_auth_pass; ?>"
                                   placeholder="<?php echo $entry_auth_pass; ?>" id="input-auth-pass"
                                   class="form-control"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="perpetual_payments_total"
                                   value="<?php echo $perpetual_payments_total; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="perpetual_payments_sort_order"
                                   value="<?php echo $perpetual_payments_sort_order; ?>"
