...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-pp-express" data-toggle="tooltip" title="<?php echo $button_save; ?>"
                        class="btn btn-primary"><i class="fa fa-save"></i></button>
                <a href="<?php echo $cancel; ?>" data-toggle="tooltip" title="<?php echo $button_cancel; ?>"
                   class="btn btn-default"><i class="fa fa-reply"></i></a> <a href="<?php echo $search; ?>"
                                                                              data-toggle="tooltip"
                                                                              title="<?php echo $button_search; ?>"
    ...
    <div class="container-fluid">
        ...
        <?php } ?>
        <div class="alert alert-info"><a data-paypal-button="true" target="PPFrame" href="<?php echo $signup; ?>"><i
                        class="fa fa-info-circle"></i> <?php echo $text_signup; ?></a>
            <button type="button" class="close" data-dismiss="alert">&times;</button>
        </div>
        <div class="alert alert-info"><a data-paypal-button="true" target="PPFrame" href="<?php echo $sandbox; ?>"><i
                        class="fa fa-info-circle"></i> <?php echo $text_sandbox; ?></a>
            <button type="button" class="close" data-dismiss="alert">&times;</button>
        </div>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-pp-express"
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-api">
                            <div class="form-group required">
                                <label class="col-sm-2 control-label"
                                       for="entry-username"><?php echo $entry_username; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="pp_express_username"
                                           value="<?php echo $pp_express_username; ?>"
                                           placeholder="<?php echo $entry_username; ?>" id="entry-username"
                                           class="form-control"/>
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label"
                                       for="entry-password"><?php echo $entry_password; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="pp_express_password"
                                           value="<?php echo $pp_express_password; ?>"
                                           placeholder="<?php echo $entry_password; ?>" id="entry-password"
                                           class="form-control"/>
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label"
                                       for="entry-signature"><?php echo $entry_signature; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="pp_express_signature"
                                           value="<?php echo $pp_express_signature; ?>"
                                           placeholder="<?php echo $entry_signature; ?>" id="entry-signature"
                                           class="form-control"/>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="entry-sandbox-username"><?php echo $entry_sandbox_username; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="pp_express_sandbox_username"
                                           value="<?php echo $pp_express_sandbox_username; ?>"
                                           placeholder="<?php echo $entry_sandbox_username; ?>"
                                           id="entry-sandbox-username" class="form-control"/>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="entry-sandbox-password"><?php echo $entry_sandbox_password; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="pp_express_sandbox_password"
                                           value="<?php echo $pp_express_sandbox_password; ?>"
                                           placeholder="<?php echo $entry_sandbox_password; ?>"
                                           id="entry-sandbox-password" class="form-control"/>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="entry-sandbox-signature"><?php echo $entry_sandbox_signature; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="pp_express_sandbox_signature"
                                           value="<?php echo $pp_express_sandbox_signature; ?>"
                                           placeholder="<?php echo $entry_sandbox_signature; ?>"
                                           id="entry-sandbox-signature" class="form-control"/>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><span data-toggle="tooltip"
                                                                            title="<?php echo $help_ipn; ?>"><?php echo $entry_ipn; ?></span></label>
                                <div class="col-sm-10">
                        ...
                        <div class="tab-pane" id="tab-general">
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="input-test"><?php echo $entry_test; ?></label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="input-debug"><?php echo $entry_debug; ?></label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="input-recurring-cancel"><?php echo $entry_recurring_cancel; ?></label>
                                <div class="col-sm-10">
                                    <select name="pp_express_recurring_cancel" id="input-recurring-cancel"
                                            class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="pp_express_sort_order"
                                           value="<?php echo $pp_express_sort_order; ?>"
                        ...
                        <div class="tab-pane" id="tab-order-status">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="pp_express_completed_status_id" id="input-completed-status"
                                            class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="pp_express_denied_status_id" id="input-denied-status"
                                            class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="pp_express_expired_status_id" id="input-expired-status"
                                            class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="pp_express_failed_status_id" id="input-failed-status"
                                            class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="pp_express_pending_status_id" id="input-pending-status"
                                            class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="pp_express_processed_status_id" id="input-processed-status"
                                            class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="pp_express_refunded_status_id" id="input-refunded-status"
                                            class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="pp_express_reversed_status_id" id="input-reversed-status"
                                            class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="input-voided-status"><?php echo $entry_voided_status; ?></label>
                                <div class="col-sm-10">
                                    <select name="pp_express_voided_status_id" id="input-voided-status"
                                            class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                        ...
                        <div class="tab-pane" id="tab-checkout">
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="input-notes"><?php echo $entry_allow_notes; ?></label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-color"><span data-toggle="tooltip"
                                                                                              title="<?php echo $help_colour; ?>"><?php echo $entry_colour; ?></span></label>
                                <div class="col-sm-10">
                                    <input type="text" name="pp_express_colour"
                                           value="<?php echo $pp_express_colour; ?>"
                                           placeholder="<?php echo $entry_colour; ?>" id="input-color"
                                           class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><span data-toggle="tooltip"
                                                                            title="<?php echo $help_logo; ?>"><?php echo $entry_logo; ?></span></label>
