            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form"
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label class="col-sm-4 control-label"
                                   for="input-result_url"><?php echo $entry_result_url; ?></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-link"></i></span>
                                    <input type="text" readonly="readonly" value="<?php echo $ocstore_w1_result_url; ?>"
                                           id="input-result_url" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-link"></i></span>
                                    <input type="text" readonly="readonly" value="MD5" id="input-ecp"
                                           class="form-control">
                                </div>
                            </div>
                        </div>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group required">
                            <label class="col-sm-2 control-label" for="input-mer"><?php echo $entry_sign; ?></label>
                            <div class="col-sm-10">
                                <input type="text" name="mer_id" value="<?php echo $mer_id; ?>"
                                       placeholder="<?php echo $entry_sign; ?>" id="input-mer" class="form-control"/>
                                <?php if ($error_sign) { ?>
                                <div class="text-danger"><?php echo $error_sign; ?></div>
                                <?php } ?>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="ocstore_w1_order_confirm_status_id" id="input-order_confirm_status"
                                        class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="ocstore_w1_order_fail_status_id" id="input-order_fail_status"
                                        class="form-control">
                                    <?php foreach ($order_statuses as $order_status) { ?>
                                    <?php if (!isset($order_status['order_status_id'])) continue; ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="ocstore_w1_sort_order"
                                       value="<?php echo $ocstore_w1_sort_order; ?>"
