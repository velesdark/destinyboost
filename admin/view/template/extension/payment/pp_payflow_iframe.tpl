    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-pp-payflow-iframe" data-toggle="tooltip"
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                      id="form-pp-payflow-iframe" class="form-horizontal">
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="entry-vender"><span data-toggle="tooltip"
                                                                                       title="<?php echo $help_vendor; ?>"><?php echo $entry_vendor; ?></span></label>
                        <div class="col-sm-10">
                            <input type="text" name="pp_payflow_iframe_vendor"
                                   value="<?php echo $pp_payflow_iframe_vendor; ?>"
                                   placeholder="<?php echo $entry_vendor; ?>" id="entry-vender" class="form-control"/>
                            <?php if ($error_vendor) { ?>
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="entry-user"><span data-toggle="tooltip"
                                                                                     title="<?php echo $help_user; ?>"><?php echo $entry_user; ?></span></label>
                        <div class="col-sm-10">
                            <input type="text" name="pp_payflow_iframe_user"
                                   value="<?php echo $pp_payflow_iframe_user; ?>"
                                   placeholder="<?php echo $entry_user; ?>" id="entry-user" class="form-control"/>
                            <?php if ($error_user) { ?>
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="entry-password"><span data-toggle="tooltip"
                                                                                         title="<?php echo $help_password; ?>"><?php echo $entry_password; ?></span></label>
                        <div class="col-sm-10">
                            <input type="text" name="pp_payflow_iframe_password"
                                   value="<?php echo $pp_payflow_iframe_password; ?>"
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="entry-partner"><span data-toggle="tooltip"
                                                                                        title="<?php echo $help_partner; ?>"><?php echo $entry_partner; ?></span></label>
                        <div class="col-sm-10">
                            <input type="text" name="pp_payflow_iframe_partner"
                                   value="<?php echo $pp_payflow_iframe_partner; ?>"
                                   placeholder="<?php echo $entry_partner; ?>" id="entry-partner" class="form-control"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="pp_payflow_iframe_transaction_method" id="input-transaction"
                                    class="form-control">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-checkout-method"><span data-toggle="tooltip"
                                                                                                title="<?php echo $help_checkout_method; ?>"><?php echo $entry_checkout_method; ?></span></label>
                        <div class="col-sm-10">
                            <select name="pp_payflow_iframe_checkout_method" id="input-checkout-method"
                                    class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="pp_payflow_iframe_order_status_id" id="input-order-status"
                                    class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="pp_payflow_iframe_total"
                                   value="<?php echo $pp_payflow_iframe_total; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="pp_payflow_iframe_sort_order"
                                   value="<?php echo $pp_payflow_iframe_sort_order; ?>"
