                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-account">
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="firstdata_merchant_id"
                                           value="<?php echo $firstdata_merchant_id; ?>"
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" name="firstdata_secret"
                                           value="<?php echo $firstdata_secret; ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="firstdata_total" value="<?php echo $firstdata_total; ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="firstdata_sort_order"
                                           value="<?php echo $firstdata_sort_order; ?>"
                        ...
                        <div class="tab-pane" id="tab-order-status">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="firstdata_order_status_success_settled_id"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="firstdata_order_status_success_unsettled_id"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="firstdata_order_status_decline_id" id="input-order-status-decline"
                                            class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="input-order-status-void"><?php echo $entry_status_void; ?></label>
                                <div class="col-sm-10">
                                    <select name="firstdata_order_status_void_id" id="input-order-status-void"
                                            class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="firstdata_auto_settle" id="input-auto-settle" class="form-control">
                                        <option value="0"
                                        <?php echo ($firstdata_auto_settle == 0 ? ' selected' : ''); ?>
                                        ><?php echo $text_settle_delayed; ?></option>
                                        <option value="1"
                                        <?php echo ($firstdata_auto_settle == 1 ? ' selected' : ''); ?>
                        ...
                        <div class="tab-pane" id="tab-advanced">
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="firstdata_live_url"
                                           value="<?php echo $firstdata_live_url; ?>"
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="firstdata_demo_url"
                                           value="<?php echo $firstdata_demo_url; ?>"
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-sort-order"><span data-toggle="tooltip"
                                                                                                   title="<?php echo $help_notification; ?>"><?php echo $text_notification_url; ?></span></label>
                                <div class="col-sm-10">
