    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-sagepay-server" data-toggle="tooltip"
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                      id="form-sagepay-server" class="form-horizontal">
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-vendor"><?php echo $entry_vendor; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="sagepay_server_vendor"
                                   value="<?php echo $sagepay_server_vendor; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="sagepay_server_total" value="<?php echo $sagepay_server_total; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="sagepay_server_sort_order"
                                   value="<?php echo $sagepay_server_sort_order; ?>"
                                   placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order"
                                   class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="sagepay_server_cron_job_token"><span
                                    data-toggle="tooltip"
                                    title="<?php echo $help_cron_job_token; ?>"><?php echo $entry_cron_job_token; ?></span></label>
                        <div class="col-sm-10">
                            <input type="text" name="sagepay_server_cron_job_token"
                                   value="<?php echo $sagepay_server_cron_job_token; ?>"
                                   placeholder="<?php echo $entry_cron_job_token; ?>" id="sagepay_server_cron_job_token"
                                   class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10"><span
                                    id="cron-job-url"><?php echo $sagepay_server_cron_job_url; ?></span></div>
                    </div>
                    <div class="form-group">
