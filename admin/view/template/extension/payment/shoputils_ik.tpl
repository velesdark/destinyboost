    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-shoputils-ik"
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="shoputils_ik_sort_order"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="shoputils_ik_minimal_order"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="shoputils_ik_maximal_order"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="shoputils_ik_order_confirm_status_id" id="input-order-confirm-status"
                                            class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="shoputils_ik_order_status_id" id="input-order-status"
                                            class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="shoputils_ik_order_fail_status_id" id="input-order-fail-status"
                                            class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                                        <?php if (!$order_status['order_status_id']) continue; ?>
                        ...
                        <div class="tab-pane" id="tab-settings">
                            <div class="form-group required">
                                <label class="col-sm-2 control-label"
                                       for="input-shop-id"><?php echo $entry_shop_id; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="shoputils_ik_shop_id"
                                           value="<?php echo $shoputils_ik_shop_id; ?>"
                                           placeholder="<?php echo $entry_shop_id; ?>" id="input-shop-id"
                                           class="form-control"/>
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label"
                                       for="input-sign-hash"><?php echo $entry_sign_hash; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="shoputils_ik_sign_hash"
                                           value="<?php echo $shoputils_ik_sign_hash; ?>"
                                           placeholder="<?php echo $entry_sign_hash; ?>" id="input-sign-hash"
                                           class="form-control"/>
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label"
                                       for="input-sign-test-key"><?php echo $entry_sign_test_key; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="shoputils_ik_sign_test_key"
                                           value="<?php echo $shoputils_ik_sign_test_key; ?>"
                                           placeholder="<?php echo $entry_sign_test_key; ?>" id="input-sign-test-key"
                                           class="form-control"/>
                            ...
                            <div class="form-group" style="display:none;">
                                <label class="col-sm-2 control-label"
                                       for="input-lifetime"><?php echo $entry_lifetime; ?></label>
                                <div class="col-sm-10">
                        ...
                        <div class="tab-pane" id="tab-log">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="hidden" name="shoputils_ik_log_filename"
                        ...
                        <div class="tab-pane" id="tab-information">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label"
                                       for="input-success_url"><?php echo $entry_success_url; ?></label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-link"></i></span>
                                        <input type="text" readonly="readonly"
                                               value="<?php echo $shoputils_ik_success_url; ?>" id="input-success_url"
                                               class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label"
                                       for="input-fail_url"><?php echo $entry_fail_url; ?></label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-link"></i></span>
                                        <input type="text" readonly="readonly"
                                               value="<?php echo $shoputils_ik_fail_url; ?>" id="input-fail_url"
                                               class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label"
                                       for="input-pending_url"><?php echo $entry_pending_url; ?></label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-link"></i></span>
                                        <input type="text" readonly="readonly"
                                               value="<?php echo $shoputils_ik_pending_url; ?>" id="input-pending_url"
                                               class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label"
                                       for="input-status_url"><?php echo $entry_status_url; ?></label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-link"></i></span>
                                        <input type="text" readonly="readonly"
                                               value="<?php echo $shoputils_ik_status_url; ?>" id="input-status_url"
                                               class="form-control">
                                    </div>
                                </div>
                            </div>
