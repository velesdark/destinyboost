    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-ocstore-payeer" class="btn btn-primary"><i
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                      id="form-ocstore-payeer" class="form-horizontal">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="ocstore_payeer_sort_order"
                                           value="<?php echo $ocstore_payeer_sort_order; ?>"
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="input-minimal-order"><?php echo $entry_minimal_order; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="ocstore_payeer_minimal_order"
                                           value="<?php echo $ocstore_payeer_minimal_order; ?>"
                                           placeholder="<?php echo $entry_minimal_order; ?>" id="input-minimal-order"
                                           class="form-control"/>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="input-maximal-order"><?php echo $entry_maximal_order; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="ocstore_payeer_maximal_order"
                                           value="<?php echo $ocstore_payeer_maximal_order; ?>"
                                           placeholder="<?php echo $entry_maximal_order; ?>" id="input-maximal-order"
                                           class="form-control"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="ocstore_payeer_order_confirm_status_id"
                                            id="input-order-confirm-status" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="ocstore_payeer_order_status_id" id="input-order-status"
                                            class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="ocstore_payeer_order_fail_status_id" id="input-order-fail-status"
                                            class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                            ...
                            <div class="form-group" id="laterpay-mode-tr" style="display: none;">
                                ...
                                <div class="col-sm-10">
                                    <select name="ocstore_payeer_order_later_status_id" id="input-order-later-status"
                                            class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"
                                               name="ocstore_payeer_langdata[<?php echo $language['language_id']; ?>][title]"
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-addon"><img src="<?php echo $language_image; ?>"
                                                                             title="<?php echo $language['name']; ?>"/></span>
                                        <input type="text"
                                               name="ocstore_payeer_langdata[<?php echo $language['language_id']; ?>][button_confirm]"
                        ...
                        <div class="tab-pane" id="tab-emails">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-addon"><img src="<?php echo $language_image; ?>"
                                                                             title="<?php echo $language['name']; ?>"/></span>
                                        <input type="text"
                                               name="ocstore_payeer_langdata[<?php echo $language['language_id']; ?>][mail_customer_success_subject]"
                                  ...
                                  ? $ocstore_payeer_langdata[$language['language_id']]['mail_customer_success_subject'] : $sample_mail_customer_success_subject; ?>"
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-addon"><img src="<?php echo $language_image; ?>"
                                                                             title="<?php echo $language['name']; ?>"/></span>
                                        <textarea
                                                name="ocstore_payeer_langdata[<?php echo $language['language_id']; ?>][mail_customer_success_content]"
                                                rows="5"
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-addon"><img src="<?php echo $language_image; ?>"
                                                                             title="<?php echo $language['name']; ?>"/></span>
                                        <input type="text"
                                               name="ocstore_payeer_langdata[<?php echo $language['language_id']; ?>][mail_customer_fail_subject]"
                                  ...
                                  ? $ocstore_payeer_langdata[$language['language_id']]['mail_customer_fail_subject'] : $sample_mail_customer_fail_subject; ?>"
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-addon"><img src="<?php echo $language_image; ?>"
                                                                             title="<?php echo $language['name']; ?>"/></span>
                                        <textarea
                                                name="ocstore_payeer_langdata[<?php echo $language['language_id']; ?>][mail_customer_fail_content]"
                                                rows="5"
                            ...
                            <div class="form-group required" id="mail-admin-success-tr" style="display: none;">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="text" name="ocstore_payeer_mail_admin_success_subject"
                            ...
                            <div class="form-group required" id="mail-admin-fail-tr" style="display: none;">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="text" name="ocstore_payeer_mail_admin_fail_subject"
                        ...
                        <div class="tab-pane" id="tab-settings">
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="ocstore_payeer_shop_id"
                                           value="<?php echo $ocstore_payeer_shop_id; ?>"
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label"
                                       for="input-sign_hash"><?php echo $entry_sign_hash; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="ocstore_payeer_sign_hash"
                                           value="<?php echo $ocstore_payeer_sign_hash; ?>"
                                           placeholder="<?php echo $entry_sign_hash; ?>" id="input-sign_hash"
                                           class="form-control"/>
                        ...
                        <div class="tab-pane" id="tab-log">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="hidden" name="ocstore_payeer_log_filename"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="well well-sm" style="height: 300px; overflow: auto;">
                                        <pre id="pre-log"
                                             style="font-size:11px; min-height: 280px;"><?php foreach ($log_lines as $log_line) {echo $log_line;} ?></pre>
                                    </div>
