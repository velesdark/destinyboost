...
<div id="content">
    ...
    <div class="container-fluid">
        <div class="panel-body">
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-worldpay"
                    ...
                    <div class="tab-pane active" id="tab-general">
                        <div class="form-group required">
                            <label class="col-sm-2 control-label"
                                   for="input-service-key"><?php echo $entry_service_key; ?></label>
                            <div class="col-sm-10">
                                <input type="text" name="worldpay_service_key"
                                       value="<?php echo $worldpay_service_key; ?>"
                                       placeholder="<?php echo $entry_service_key; ?>" id="input-service-key"
                                       class="form-control"/>
                        ...
                        <div class="form-group required">
                            <label class="col-sm-2 control-label"
                                   for="input-client-key"><?php echo $entry_client_key; ?></label>
                            <div class="col-sm-10">
                                <input type="text" name="worldpay_client_key"
                                       value="<?php echo $worldpay_client_key; ?>"
                                       placeholder="<?php echo $entry_client_key; ?>" id="input-client-key"
                                       class="form-control"/>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="input-secret-token"><span data-toggle="tooltip"
                                                                                                 title="<?php echo $help_secret_token; ?>"><?php echo $entry_secret_token; ?></span></label>
                            <div class="col-sm-10">
                                <input type="text" name="worldpay_secret_token"
                                       value="<?php echo $worldpay_secret_token; ?>" id="input-secret-token"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="input-webhook-url"><span data-toggle="tooltip"
                                                                                                title="<?php echo $help_webhook_url; ?>"><?php echo $entry_webhook_url; ?></span></label>
                            <div class="col-sm-10">
                                <div class="input-group"><span class="input-group-addon"><i
                                                class="fa fa-link"></i></span>
                                    <input type="text" readonly value="<?php echo $worldpay_webhook_url; ?>"
                                           id="input-webhook-url" class="form-control"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="input-cron-job-url"><span data-toggle="tooltip"
                                                                                                 title="<?php echo $help_cron_job_url; ?>"><?php echo $entry_cron_job_url; ?></span></label>
                            <div class="col-sm-10">
                                <div class="input-group"><span class="input-group-addon"><i
                                                class="fa fa-link"></i></span>
                                    <input type="text" readonly value="<?php echo $worldpay_cron_job_url; ?>"
                                           id="input-cron-job-url" class="form-control"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"
                                   for="input-cron-job-last-run"><?php echo $entry_last_cron_job_run; ?></label>
                            <div class="col-sm-10">
                                <input type="text" readonly value="<?php echo $worldpay_last_cron_job_run; ?>"
                                       id="input-cron-job-last-run" class="form-control"/>
                            </div>
                        </div>
                        <?php } ?>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="worldpay_sort_order"
                                       value="<?php echo $worldpay_sort_order; ?>"
