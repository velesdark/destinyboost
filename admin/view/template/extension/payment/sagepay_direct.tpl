    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-sagepay-direct" data-toggle="tooltip"
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                      id="form-sagepay-direct" class="form-horizontal">
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-vendor"><?php echo $entry_vendor; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="sagepay_direct_vendor"
                                   value="<?php echo $sagepay_direct_vendor; ?>"
                                   placeholder="<?php echo $entry_vendor; ?>" id="input-vendor" class="form-control"/>
                            <?php if ($error_vendor) { ?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-transaction"><span data-toggle="tooltip"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="sagepay_direct_sort_order"
                                   value="<?php echo $sagepay_direct_sort_order; ?>"
                                   placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order"
                                   class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="sagepay-direct-cron-job-token"><span
                                    data-toggle="tooltip"
                                    title="<?php echo $help_cron_job_token; ?>"><?php echo $entry_cron_job_token; ?></span></label>
                        <div class="col-sm-10">
                            <div class="input-group">
                                <input type="text" name="sagepay_direct_cron_job_token"
                                       value="<?php echo $sagepay_direct_cron_job_token; ?>"
                                       placeholder="<?php echo $entry_cron_job_token; ?>"
                                       id="sagepay-direct-cron-job-token" class="form-control"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="cron-job-url"><span data-toggle="tooltip"
                                                                                       title="<?php echo $help_cron_job_url; ?>"><?php echo $entry_cron_job_url; ?></span></label>
                        <div class="col-sm-10">
                            <input type="text" name="sagepay_direct_cron_job_url"
                                   value="<?php echo $sagepay_direct_cron_job_url; ?>"
                                   placeholder="<?php echo $entry_cron_job_url; ?>" id="input-cron-job-url"
                                   class="form-control"/>
                        </div>
                    </div>
