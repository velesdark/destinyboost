...
<table class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <td id="capture_status"><?php if ($firstdata_order['capture_status'] == 1 ) { ?>
            ...
            <a class="btn btn-primary" id="button-capture"><?php echo $button_capture; ?></a> <span
    ...
    <tr>
        ...
        <td id="void_status"><?php if ($firstdata_order['void_status'] == 1) { ?>
            ...
            <a class="btn btn-primary" id="button-void"><?php echo $button_void; ?></a> <span class="btn btn-primary"
                                                                                              id="img_loading_void"
    ...
    <tr>
        ...
        <td id="refund_status"><?php if ($firstdata_order['refund_status'] == 1) { ?>
            ...
            <?php } else { ?>
            <span class="refund_text"><?php echo $text_no; ?></span>&nbsp;&nbsp; <a class="btn btn-primary"
                                                                                    id="button-refund" <?php if ($firstdata_order['capture_status'] == 0 || $firstdata_order['void_status'] == 1) { echo 'style="display:none;"'; } ?>
            ><?php echo $button_refund; ?></a> <span class="btn btn-primary" id="img_loading_refund"
                                                     style="display:none;"><i
                        class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>
            <?php } ?></td>
    </tr>
