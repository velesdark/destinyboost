    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-twocheckout" data-toggle="tooltip" title="<?php echo $button_save; ?>"
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-twocheckout"
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-secret"><span data-toggle="tooltip"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="twocheckout_sort_order"
                                   value="<?php echo $twocheckout_sort_order; ?>"
