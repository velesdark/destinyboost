...
<table class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <td>
            <input type="text" style="width:80px" id="tracking" maxlength="50"
                   value="<?php echo $pilibaba_order['tracking']; ?>"/>
            <a class="button btn btn-primary btn-sm" id="button-tracking"><?php echo $button_tracking; ?></a> <span
                    class="btn btn-primary btn-sm" id="img_loading_tracking" style="display:none"><i
    ...
    <tr>
        ...
        <td>
            <a href="<?php echo $barcode; ?>" target="_blank"
               class="button btn btn-primary btn-sm"><?php echo $button_barcode; ?></a>
