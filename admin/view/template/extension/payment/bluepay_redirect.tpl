    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-bluepay-redirect" class="btn btn-primary"><i
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                      id="form-bluepay-redirect" class="form-horizontal">
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-vendor"><?php echo $entry_vendor; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="bluepay_redirect_account_id"
                                   value="<?php echo $bluepay_redirect_account_id; ?>"
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label"
                               for="bluepay_redirect_secret_key"><?php echo $entry_secret_key; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="bluepay_redirect_secret_key"
                                   value="<?php echo $bluepay_redirect_secret_key; ?>"
                                   placeholder="<?php echo $entry_secret_key; ?>" id="bluepay_redirect_secret_key"
                                   class="form-control"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="bluepay_redirect_total"
                                   value="<?php echo $bluepay_redirect_total; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="bluepay_redirect_order_status_id" id="input-order-status"
                                    class="form-control">
