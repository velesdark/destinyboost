    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-cardinity" data-toggle="tooltip" title="<?php echo $button_save; ?>"
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-cardinity"
                      class="form-horizontal">
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-key"><?php echo $entry_key; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="cardinity_key" value="<?php echo $cardinity_key; ?>"
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="cardinity_secret" value="<?php echo $cardinity_secret; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="cardinity_total" value="<?php echo $cardinity_total; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="cardinity_sort_order" value="<?php echo $cardinity_sort_order; ?>"
