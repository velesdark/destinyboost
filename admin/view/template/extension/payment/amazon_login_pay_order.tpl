...
<table class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <td id="capture_status">
            ...
            <span class="btn btn-primary" id="loading-capture" style="display:none;"><i
    ...
    <tr>
        ...
        <td id="cancel_status">
            ...
            <span class="btn btn-primary" id="loading-cancel" style="display:none;"><i
                        class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>
            <?php } ?>
            <?php } ?>
        </td>
    ...
    <tr>
        ...
        <td id="refund_status">
            ...
            <?php } ?>
            <span class="btn btn-primary" id="loading-refund" style="display:none;"><i
                        class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>
            <?php } ?>
        </td>
    </tr>
