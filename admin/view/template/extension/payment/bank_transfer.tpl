    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-bank-transfer" data-toggle="tooltip"
                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label"
                               for="input-bank<?php echo $language['language_id']; ?>"><?php echo $entry_bank; ?></label>
                        <div class="col-sm-10">
                            <div class="input-group"><span class="input-group-addon"><img
                                ...
                                <textarea name="bank_transfer_bank<?php echo $language['language_id']; ?>" cols="80"
                                          rows="10" placeholder="<?php echo $entry_bank; ?>"
                                          id="input-bank<?php echo $language['language_id']; ?>"
                                          class="form-control"><?php echo isset(${'bank_transfer_bank' . $language['language_id']}) ? ${'bank_transfer_bank' . $language['language_id']} : ''; ?></textarea>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="bank_transfer_total" value="<?php echo $bank_transfer_total; ?>"
