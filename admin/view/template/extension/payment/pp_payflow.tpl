    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-pp-payflow" data-toggle="tooltip" title="<?php echo $button_save; ?>"
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-pp-payflow"
                      class="form-horizontal">
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="entry-vendor"><span data-toggle="tooltip"
                                                                                       title="<?php echo $help_vendor; ?>"><?php echo $entry_vendor; ?></span></label>
                        <div class="col-sm-10">
                            <input type="text" name="pp_payflow_vendor" value="<?php echo $pp_payflow_vendor; ?>"
                                   placeholder="<?php echo $entry_vendor; ?>" id="entry-vendor" class="form-control"/>
                            <?php if ($error_vendor) { ?>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="pp_payflow_user" value="<?php echo $pp_payflow_user; ?>"
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="pp_payflow_password" value="<?php echo $pp_payflow_password; ?>"
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="pp_payflow_partner" value="<?php echo $pp_payflow_partner; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="pp_payflow_total" value="<?php echo $pp_payflow_total; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="pp_payflow_sort_order"
                                   value="<?php echo $pp_payflow_sort_order; ?>"
