    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-pp-std-uk"
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            <div class="form-group required">
                                <label class="col-sm-2 control-label"
                                       for="entry-email"><?php echo $entry_email; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="pp_standard_email"
                                           value="<?php echo $pp_standard_email; ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="pp_standard_total"
                                           value="<?php echo $pp_standard_total; ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="pp_standard_sort_order"
                                           value="<?php echo $pp_standard_sort_order; ?>"
                        ...
                        <div class="tab-pane" id="tab-status">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="pp_standard_voided_status_id" id="input-void-status"
                                            class="form-control">
                                        <?php foreach ($order_statuses as $order_status) { ?>
