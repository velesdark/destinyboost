    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-skrill" data-toggle="tooltip" title="<?php echo $button_save; ?>"
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-g2apay"
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="g2apay_username" value="<?php echo $g2apay_username; ?>"
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="g2apay_secret" value="<?php echo $g2apay_secret; ?>"
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label"
                                       for="input-api-hash"><?php echo $entry_api_hash; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="g2apay_api_hash" value="<?php echo $g2apay_api_hash; ?>"
                                           placeholder="<?php echo $entry_api_hash; ?>" id="input-api-hash"
                                           class="form-control"/>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"
                                       for="input-environment"><?php echo $entry_environment; ?></label>
                                <div class="col-sm-10">
                                    <select name="g2apay_environment" class="form-control" id="input-environment">
                                        <?php if ($g2apay_environment) { ?>
                                        <option value="1"
                                                selected="selected"><?php echo $g2apay_environment_live; ?></option>
                                        <option value="0"><?php echo $g2apay_environment_test; ?></option>
                                        <?php } else { ?>
                                        <option value="1"><?php echo $g2apay_environment_live; ?></option>
                                        <option value="0"
                                                selected="selected"><?php echo $g2apay_environment_test; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-secret-token"><span
                                            data-toggle="tooltip"
                                            title="<?php echo $help_secret_token; ?>"><?php echo $entry_secret_token; ?></span></label>
                                <div class="col-sm-10">
                                    <input type="text" name="g2apay_secret_token"
                                           value="<?php echo $g2apay_secret_token; ?>" id="input-secret-token"
                                           class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-ipn-url"><span data-toggle="tooltip"
                                                                                                title="<?php echo $help_ipn_url; ?>"><?php echo $entry_ipn_url; ?></span></label>
                                <div class="col-sm-10">
                                    <div class="input-group"><span class="input-group-addon"><i class="fa fa-link"></i></span>
                                        <input type="text" readonly value="<?php echo $g2apay_ipn_url; ?>"
                                               id="input-ipn-url" class="form-control"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="g2apay_total" value="<?php echo $g2apay_total; ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="g2apay_sort_order"
                                           value="<?php echo $g2apay_sort_order; ?>"
