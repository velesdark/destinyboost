...
<table class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <td id="release_status"><?php if ($bluepay_redirect_order['release_status'] == 1) { ?>
            ...
            <a class="button btn btn-primary" id="button-release"><?php echo $button_release; ?></a> <span
                    class="btn btn-primary" id="img_loading_release" style="display:none;"><i
    ...
    <tr>
        ...
        <td id="void_status"><?php if ($bluepay_redirect_order['void_status'] == 1) { ?>
            ...
            <span class="void_text"><?php echo $text_no; ?></span>&nbsp;&nbsp; <a class="button btn btn-primary"
                                                                                  id="button-void"><?php echo $button_void; ?></a>
            <span class="btn btn-primary" id="img_loading_void" style="display:none;"><i
                        class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>
            <?php } else { ?>
    ...
    <tr>
        ...
        <td id="rebate_status"><?php if ($bluepay_redirect_order['rebate_status'] == 1) { ?>
            ...
            <?php if ($bluepay_redirect_order['total_released'] > 0 && $bluepay_redirect_order['void_status'] == 0 &&
            $bluepay_redirect_order['release_status'] == 1) { ?>
            <input type="text" width="10" id="rebate_amount"/>
            <a class="button btn btn-primary" id="button-rebate"><?php echo $button_rebate; ?></a> <span
                    class="btn btn-primary" id="img_loading_rebate" style="display:none;"><i
                        class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>
            <?php } ?>
            <?php } ?></td>
    </tr>
