    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-eway" data-toggle="tooltip" title="<?php echo $button_save; ?>"
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-eway"
                        ...
                        <div class="col-sm-10">
                            <select name="eway_paymode" id="input-test" class="form-control">
                                ...
                                <option value="transparent"
                                        selected="selected"><?php echo $text_transparent; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-test"><span data-toggle="tooltip"
                                                                                     title="<?php echo $help_testmode; ?>"><?php echo $entry_test; ?></span></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="eway_username" value="<?php echo $eway_username; ?>"
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="password" name="eway_password" value="<?php echo $eway_password; ?>"
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-transaction-method"><span data-toggle="tooltip"
                                                                                                   title="<?php echo $help_transaction_method; ?>"><?php echo $entry_transaction_method; ?></span></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label"
                               for="eway_payment_type"><?php echo $entry_payment_type; ?></label>
                        <div class="col-sm-10">
                            <p>
                                <input type="hidden" name="eway_payment_type[visa]" value="0"/>
                                <input type='checkbox' name='eway_payment_type[visa]' id="eway_payment_type"
                                       value='1' <?php echo (isset($eway_payment_type['visa']) && $eway_payment_type['visa'] == 1 ? 'checked="checked"' : '') ?>
                                /> CC - Visa
                            </p>
                            <p>
                                <input type="hidden" name="eway_payment_type[mastercard]" value="0"/>
                                <input type='checkbox' name='eway_payment_type[mastercard]'
                                       value='1' <?php echo (isset($eway_payment_type['mastercard']) && $eway_payment_type['mastercard'] == 1 ? 'checked="checked"' : '') ?>
                                /> CC - MasterCard
                            </p>
                            <p>
                                <input type="hidden" name="eway_payment_type[amex]" value="0"/>
                                <input type='checkbox' name='eway_payment_type[amex]'
                                       value='1' <?php echo (isset($eway_payment_type['amex']) && $eway_payment_type['amex'] == 1 ? 'checked="checked"' : '') ?>
                                /> CC - Amex
                            </p>
                            <p>
                                <input type="hidden" name="eway_payment_type[diners]" value="0"/>
                                <input type='checkbox' name='eway_payment_type[diners]'
                                       value='1' <?php echo (isset($eway_payment_type['diners']) && $eway_payment_type['diners'] == 1 ? 'checked="checked"' : '') ?>
                                /> CC - Diners Club
                            </p>
                            <p>
                                <input type="hidden" name="eway_payment_type[jcb]" value="0"/>
                                <input type='checkbox' name='eway_payment_type[jcb]'
                                       value='1' <?php echo (isset($eway_payment_type['jcb']) && $eway_payment_type['jcb'] == 1 ? 'checked="checked"' : '') ?>
                                /> CC - JCB
                            </p>
                            <p>
                                <input type="hidden" name="eway_payment_type[paypal]" value="0"/>
                                <input type='checkbox' name='eway_payment_type[paypal]'
                                       value='1' <?php echo (isset($eway_payment_type['paypal']) && $eway_payment_type['paypal'] == 1 ? 'checked="checked"' : '') ?>
                                /> PayPal
                            </p>
                            <p>
                                <input type="hidden" name="eway_payment_type[masterpass]" value="0"/>
                                <input type='checkbox' name='eway_payment_type[masterpass]'
                                       value='1' <?php echo (isset($eway_payment_type['masterpass']) && $eway_payment_type['masterpass'] == 1 ? 'checked="checked"' : '') ?>
                                /> MasterPass
                            </p>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-order-status-refund"><?php echo $entry_order_status_refund; ?></label>
                        <div class="col-sm-10">
                            <select name="eway_order_status_refunded_id" id="input-order-status-refund"
                                    class="form-control">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-order-status-auth"><?php echo $entry_order_status_auth; ?></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-order-status-fraud"><?php echo $entry_order_status_fraud; ?></label>
                        <div class="col-sm-10">
                            <select name="eway_order_status_fraud_id" id="input-order-status-fraud"
                                    class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="eway_sort_order" value="<?php echo $eway_sort_order; ?>"
