...
<table class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <td id="capture_status"><?php if ($globalpay_order['capture_status'] == 1) { ?>
            ...
            <a class="button btn btn-primary" id="button_capture"><?php echo $button_capture; ?></a> <span
                    class="btn btn-primary" id="img_loading_capture" style="display:none;"><i
    ...
    <tr>
        ...
        <td>
            <table class="table table-striped table-bordered" id="globalpay_transactions">
                <thead>
                <tr>
