<table class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <td class="text-left">
            ...
            <a href="<?php echo $transaction['view']; ?>" data-toggle="tooltip" title="<?php echo $button_view; ?>"
            ...
            <a href="<?php echo $transaction['refund']; ?>" data-toggle="tooltip" title="<?php echo $button_refund; ?>"
               class="btn btn-danger"><i class="fa fa-reply"></i></a>&nbsp;
            <?php } ?>
            <?php } else { ?>
            <button type="button" value="<?php echo $transaction['resend']; ?>" data-toggle="tooltip"
                    title="<?php echo $button_resend; ?>" class="btn btn-info"><i class="fa fa-refresh"></i></button>
            <?php } ?>
        </td>
    </tr>
    <?php } ?>
