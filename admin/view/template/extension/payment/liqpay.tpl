    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-liqpay" data-toggle="tooltip" title="<?php echo $button_save; ?>"
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-liqpay"
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label"
                               for="input-signature"><?php echo $entry_signature; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="liqpay_signature" value="<?php echo $liqpay_signature; ?>"
                                   placeholder="<?php echo $entry_signature; ?>" id="input-signature"
                                   class="form-control"/>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-order-success_status"><?php echo $entry_order_success_status; ?></label>
                        <div class="col-sm-10">
                            <select name="liqpay_order_success_status_id" id="input-order-success_status"
                                    class="form-control">
                                <?php foreach ($order_statuses as $order_status) { ?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-order-reversed_status"><?php echo $entry_order_reversed_status; ?></label>
                        <div class="col-sm-10">
                            <select name="liqpay_order_reversed_status_id" id="input-order-reversed_status"
                                    class="form-control">
                                <?php foreach ($order_statuses as $order_status) { ?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-order-processing_status"><?php echo $entry_order_processing_status; ?></label>
                        <div class="col-sm-10">
                            <select name="liqpay_order_processing_status_id" id="input-order-processing_status"
                                    class="form-control">
                                <?php foreach ($order_statuses as $order_status) { ?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-order-failure_status"><?php echo $entry_order_failure_status; ?></label>
                        <div class="col-sm-10">
                            <select name="liqpay_order_failure_status_id" id="input-order-failure_status"
                                    class="form-control">
                                <?php foreach ($order_statuses as $order_status) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="liqpay_sort_order" value="<?php echo $liqpay_sort_order; ?>"
