    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-dashboard_activity" data-toggle="tooltip"
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-dashboard"
                        ...
                        <div class="col-sm-10">
                            <select name="dashboard_activity_width" id="input-width" class="form-control">
                                ...
                                <option value="<?php echo $column; ?>"
                                        selected="selected"><?php echo $column; ?></option>
                                <?php } else { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="dashboard_activity_sort_order"
                                   value="<?php echo $dashboard_activity_sort_order; ?>"
