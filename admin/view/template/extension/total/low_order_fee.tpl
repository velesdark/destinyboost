    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-low-order-fee" data-toggle="tooltip"
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                      id="form-low-order-fee" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="low_order_fee_total" value="<?php echo $low_order_fee_total; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="low_order_fee_fee" value="<?php echo $low_order_fee_fee; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="low_order_fee_sort_order"
                                   value="<?php echo $low_order_fee_sort_order; ?>"
