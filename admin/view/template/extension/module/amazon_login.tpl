    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-amazon-login" data-toggle="tooltip" title="<?php echo $button_save; ?>"
                        class="btn btn-primary"><i class="fa fa-check-circle"></i></button>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-amazon-login"
                      class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-button-type"><?php echo $entry_button_type; ?></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-button-colour"><?php echo $entry_button_colour; ?></label>
                        <div class="col-sm-10">
                            <select name="amazon_login_button_colour" id="input-button-colour" class="form-control">
                                ...
                                <option value="DarkGray"
                                        selected="selected"><?php echo $text_darkgray_button; ?></option>
                                ...
                                <option value="LightGray"
                                        selected="selected"><?php echo $text_lightgray_button; ?></option>
                                <?php } else { ?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-button-size"><?php echo $entry_button_size; ?></label>
                        <div class="col-sm-10">
