            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-featured"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="ebay_listing_username"
                                   value="<?php echo $ebay_listing_username; ?>"
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-keywords"><?php echo $entry_keywords; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="ebay_listing_keywords"
                                   value="<?php echo $ebay_listing_keywords; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="ebay_listing_limit" value="<?php echo $ebay_listing_limit; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="ebay_listing_width" value="<?php echo $ebay_listing_width; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="ebay_listing_height" value="<?php echo $ebay_listing_height; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="ebay_listing_site" id="input-site" class="form-control">
                                ...
                                <option value="<?php echo $site['value']; ?>"
                                        selected><?php echo $site['text']; ?></option>
                                <?php } else { ?>
