    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><img src="http://www.unisender.com/favicon.ico"
                                             alt=""/> </i> <?php echo $text_edit; ?></h3>
            </div>
            <div class="panel-body">
                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form"
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="unisender_key"><span data-toggle="tooltip"
                                                                                        title="<?php echo $entry_unisender_key_help; ?>"><?php echo $entry_unisender_key; ?></span></label>
                        <div class="col-sm-10">
                            <input id="unisender_key" type="text" class="form-control" name="unisender_key"
                                   value="<?php echo $unisender_key; ?>" required/>
                            <a href="http://www.unisender.com/?a=opencart"
                               target="_blank"><?php echo $text_get_key; ?></a>
                            <div id="key_td" style="width:100%;">
                                <?php if (isset($_error['unisender_key'])) { ?>
                                <span class="error alert alert-danger col-sm-12"
                                      id="key_error"><?php echo $_error['unisender_key']; ?></span>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="subscribtion_selector"><span data-toggle="tooltip"
                                                                                                title="<?php echo $entry_unisender_subscribtion_help; ?>"><?php echo $entry_unisender_subscribtion; ?></span></label>
                        <div class="col-sm-10">
                            <select name="unisender_subscribtion[]" id="subscribtion_selector" size="10"
                                    class="form-control" multiple>
                            </select>
                            <br/><a id="unselect_subscribtions"
                                    href="javascript:void(0);"><?php echo $text_unselect; ?></a>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="checkbox" id="input-ignore" name="unisender_ignore"
                                   value="1" <?php echo $unisender_ignore ? 'checked' : ''; ?>/>
                            <label class="control-label"
                                   for="input-ignore"><?php echo $entry_unisender_ignore; ?></label>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-status"><?php echo $entry_unisender_status; ?></label>
                        <div class="col-sm-10">
