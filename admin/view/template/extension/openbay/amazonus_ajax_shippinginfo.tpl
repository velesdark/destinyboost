<div id="openbay-info">
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <select name="carrier_id" id="carrier-id" class="form-control openbay-data">
                    ...
                    <option
                    <?php if (isset($order_info['carrier_id']) && $order_info['carrier_id'] == $carrier){ echo ' selected'; } ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="courier_other"
                       value="<?php if ($order_info['courier_other']){ echo $order_info['courier_id']; } ?>"
                       placeholder="<?php echo $entry_courier_other; ?>" id="carrier-other"
                       class="form-control openbay-data"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="tracking_no"
                       value="<?php if (isset($order_info['tracking_no'])){ echo $order_info['tracking_no']; } ?>"
                       placeholder="<?php echo $entry_tracking; ?>" id="tracking-no" class="form-control openbay-data"/>
            </div>
        </div>
