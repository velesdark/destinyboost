...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <a href="<?php echo $url_create_new; ?>" data-toggle="tooltip"
                   title="<?php echo $button_create_new_listing; ?>" class="btn btn-success"><i
                            class="fa fa-plus-circle"></i></a>
                <?php } ?>
                <?php if (isset($url_delete_links)) { ?>
                <a href="<?php echo $url_delete_links; ?>" data-toggle="tooltip"
                   title="<?php echo $button_remove_links; ?>" class="btn btn-danger"><i class="fa fa-times-circle"></i></a>
                <?php } ?>
                <a href="<?php echo $url_return; ?>" data-toggle="tooltip" title="<?php echo $button_cancel; ?>"
    ...
    <div class="container-fluid">
        ...
        <div class="well">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="pull-right"><a onclick="location = '<?php echo $url_saved_listings; ?>'"
                                               class="btn btn-primary"><?php echo $button_saved_listings; ?></a></div>
                </div>
            </div>
        </div>
        <?php } ?>
