...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right"><a href="<?php echo $return; ?>" data-toggle="tooltip"
    ...
    <div class="container-fluid">
        ...
        <div class="alert alert-danger"><i
                    class="fa fa-exclamation-circle"></i> <?php echo $image_import; ?> <?php echo $text_import_images_msg1; ?>
            <a href="<?php echo $image_import_link; ?>"
               target="_blank"><?php echo $text_import_images_msg2; ?></a> <?php echo $text_import_images_msg3; ?>
        </div>
        <?php } ?>
        <?php if ($maintenance == 1){ ?>
        <div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> <?php echo $error_maintenance; ?>
        </div>
        <?php } ?>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="attention"><?php echo $text_sync_server_size; ?>
                    <strong><?php echo ini_get('post_max_size'); ?></strong></div>
                <div class="attention"><?php echo $text_sync_memory_size; ?>
                    <strong><?php echo ini_get('memory_limit'); ?></strong></div>
                <form id="form-ebay-import" class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><span data-toggle="tooltip"
                                                                    title="<?php echo $help_import_categories; ?>"><?php echo $entry_import_categories; ?></span></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><span data-toggle="tooltip"
                                                                    title="<?php echo $help_import_description; ?>"><?php echo $entry_import_description; ?></span></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><span data-toggle="tooltip"
                                                                    title="<?php echo $help_import_item_advanced; ?>"><?php echo $entry_import_item_advanced; ?></span></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10"><a class="btn btn-primary"
                                                  id="button-import"><?php echo $button_import; ?></a></div>
                    </div>
                </form>
            </div>
        </div>
