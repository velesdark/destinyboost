                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    <input type="text" name="filter_date" value="<?php echo $filter_date; ?>"
                                           placeholder="YYYY-MM-DD" data-date-format="YYYY-MM-DD" id="input-date"
                                           class="form-control"/>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td class="text-right"><a href="<?php echo $fulfillment['edit']; ?>" data-toggle="tooltip"
