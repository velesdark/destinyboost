    ...
    <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="pull-right">
                        ...
                        <a id="button-upload" class="btn btn-primary"><i
                                    class="fa fa-cloud-upload fa-lg"></i> <?php echo $button_upload; ?></a>
                        <?php } ?>
                    </div>
                </div>
            </div>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tr>
                ...
                <td class="text-right">
                    <a class="btn btn-primary" href="<?php echo $saved_product['edit_link']; ?>" data-toggle="tooltip"
                       data-original-title="<?php echo $button_edit; ?>"><i class="fa fa-pencil"></i></a>
                    <a class="btn btn-danger"
                       onclick="removeSaved('<?php echo $saved_product['product_id']; ?>', '<?php echo $saved_product['var']; ?>', this)"
                       data-toggle="tooltip" data-original-title="<?php echo $button_remove; ?>"><i
