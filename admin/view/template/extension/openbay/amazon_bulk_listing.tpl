...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right"><a href="<?php echo $link_overview; ?>" data-toggle="tooltip"
    ...
    <div class="container-fluid">
        ...
        <div class="well">
                    ...
                    <div class="form-group">
                        ...
                        <select id="filter-marketplace" name="filter_marketplace" class="form-control">
                            ...
                            <option selected="selected"
                                    value="<?php echo $marketplace['code'] ?>"><?php echo $marketplace['name'] ?></option>
                            <?php } else { ?>
            ...
            <div class="row">
                <div class="col-sm-12 text-right"><a class="btn btn-primary" id="button-filter"><i
                                class="fa fa-filter"></i> <?php echo $button_filter; ?></a> <a class="btn btn-primary"
                                                                                               id="button-search"><i
                                class="fa fa-search"></i> <?php echo $button_search; ?></a></div>
            </div>
        </div>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    <th class="text-center"><input type="checkbox"
                                                   onclick="$('input[name*=\'product_ids[]\']').prop('checked', this.checked);"/>
                    </th>
                ...
                <tr>
                    <td class="text-center"><input class="amazon-listing" type="checkbox" name="product_ids[]"
                    ...
                    <td class="text-left"><a href="<?php echo $product['href'] ?>"
                                             target="_blank"><?php echo $product['name'] ?></a></td>
                    ...
                    <td class="text-left"
                        id="result-<?php echo $product['product_id'] ?>"><?php if ($product['matches'] !== null) { ?>
                        <?php $checked = false; ?>
                        <?php if ($product['matches'] > 0) { ?>
                        <input class="amazon-listing" type="radio" name="products[<?php echo $product['product_id'] ?>]"
                               value=""/>
                        <?php echo $text_dont_list ?><br/>
                        <?php foreach ($product['search_results'] as $search_result) { ?>
                        <?php if (!$checked) { ?>
                        <input class="amazon-listing" checked="checked" type="radio"
                               name="products[<?php echo $product['product_id'] ?>]"
                               value="<?php echo $search_result['asin'] ?>"/>
                        <?php $checked = true; ?>
                        <?php } else { ?>
                        <input class="amazon-listing" type="radio" name="products[<?php echo $product['product_id'] ?>]"
                               value="<?php echo $search_result['asin'] ?>"/>
                        <?php } ?>
                        <a target="_blank"
                           href="<?php echo $search_result['href'] ?>"><?php echo $search_result['title'] ?></a><br/>
                        <?php } ?>
                        <?php } else { ?>
                        <input class="amazon-listing" checked="checked" type="radio"
                               name="products[<?php echo $product['product_id'] ?>]" value=""/>
                        <?php echo $text_dont_list ?><br/>
                        <?php } ?>
                        <?php } ?></td>
                </tr>
        ...
        <div class="well" style="margin-top:10px;">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <label for="input-condition-note"
                               class="control-label"><?php echo $entry_condition_note; ?></label>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <div class="input-group date">
                            <input type="text" class="form-control" id="input-start" data-date-format="YYYY-MM-DD"
                                   placeholder="<?php echo $entry_start_selling; ?>" name="start_selling">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="pull-right"><a class="btn btn-primary" id="button-list"><i
                                    class="fa fa-plus-circle"></i> <?php echo $button_list; ?></a></div>
                </div>
            </div>
        </div>
        <?php } else { ?>
