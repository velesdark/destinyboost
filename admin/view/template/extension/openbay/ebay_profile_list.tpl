        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="well">
                    <div class="row">
                        <div class="col-sm-12">
                            <form action="<?php echo $add; ?>" method="post" id="add-profile-form"
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <a data-toggle="tooltip" title="<?php echo $button_add; ?>"
                                           class="btn btn-primary input-group-addon"
                                           onclick="$('#add-profile-form').submit();"><i
                                                    class="fa fa-plus-circle"></i> <?php echo $button_add; ?></a>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        <td class="text-left"><?php if ($profile['default'] == 1){ echo '<strong>
                            ['.$text_profile_default.'] </strong>'; } echo $profile['name'];?>
                        </td>
                        <td class="text-left"><?php echo $types[$profile['type']]['name']; ?></td>
                        <td class="text-left"><?php echo $profile['description']; ?></td>
                        <td class="text-right">
                            <a href="<?php echo $profile['link_edit']; ?>" data-toggle="tooltip"
                               title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>&nbsp;
                            <a href="<?php echo $profile['link_delete']; ?>" data-toggle="tooltip"
                               title="<?php echo $button_delete; ?>" class="btn btn-danger profile-delete"><i
