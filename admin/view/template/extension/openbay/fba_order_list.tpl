                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label"
                                       for="input-start-date"><?php echo $entry_start_date; ?></label>
                                <div class="input-group date">
                                    <input type="text" name="filter_start" value="<?php echo $filter_start; ?>"
                                           placeholder="YYYY-MM-DD" data-date-format="YYYY-MM-DD" id="input-start-date"
                                           class="form-control"/>
                  ...
                  <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    <input type="text" name="filter_end" value="<?php echo $filter_end; ?>"
                                           placeholder="YYYY-MM-DD" data-date-format="YYYY-MM-DD" id="input-end-date"
                                           class="form-control"/>
                                    <span class="input-group-btn">
                  <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                  </span>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select name="filter_status" id="input-status" class="form-control">
                                    <option value=""
                                    <?php echo (is_null($filter_status) ? ' selected' : '') ?>
                                    ><?php echo $text_option_all; ?></option>
                                    <?php foreach ($status_options as $option_key => $option) { ?>
                                    <option value="<?php echo $option_key; ?>"
                                    <?php echo (!is_null($filter_status) && ($filter_status == $option_key) ? ' selected' : '') ?>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            <td class="text-left"><a
                                        href="<?php echo $order['order_link']; ?>"><?php echo $order['order_id']; ?></a>
                            </td>
                            ...
                            <td class="text-right"><a href="<?php echo $order['view']; ?>" data-toggle="tooltip"
                                                      title="<?php echo $button_view; ?>" class="btn btn-primary"><i
