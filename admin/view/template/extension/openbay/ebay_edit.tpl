    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="alert alert-info" id="form-loading"><i
                            class="fa fa-cog fa-lg fa-spin"></i> <?php echo $text_loading; ?> </div>
                <div class="alert alert-danger" id="form-error" style="display:none;">
                    <div class="row">
                        <div class="col-sm-8"><?php echo $text_error_loading; ?></div>
                        <div class="col-sm-4 text-right"><a id="button-load" class="btn btn-primary"><i
                                        class="fa fa-refresh"></i> <?php echo $button_retry; ?></a></div>
                    </div>
                </div>
                <div class="content displayNone" id="form-main">
                    <div class="alert alert-success" id="form-success"
                         style="display:none;"><?php echo $text_saved; ?></div>
                    ...
                    <form method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#tab-general"><?php echo $tab_general; ?></a>
                            </li>
                            <li><a data-toggle="tab" href="#tab-recommendation"><?php echo $tab_recommendations; ?></a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            <div id="tab-general" class="tab-pane active">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label"
                                           for="title"><?php echo $entry_title; ?></label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group stdMatrix">
                                    <label class="col-sm-2 control-label"
                                           for="qty-instock"><?php echo $entry_stock_store; ?></label>
                                    <div class="col-sm-2">
                                        <input type="text" name="qty_instock" id="qty-instock" class="form-control"
                                               disabled="disabled"/>
                                        <span class="help-block"><?php echo $help_stock_store; ?></span></div>
                                </div>
                                <div class="form-group stdMatrix">
                                    <label class="col-sm-2 control-label"
                                           for="qty-listed"><?php echo $entry_stock_listed; ?></label>
                                    <div class="col-sm-2">
                                        <input type="text" name="qty_listed" id="qty-listed" class="form-control"
                                               disabled="disabled"/>
                                ...
                                <div class="form-group stdMatrix">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" name="qty_reserve" value="0" id="qty-reserve"
                                               class="form-control" onkeyup="updateReserveMessage();"/>
                                ...
                                <div class="form-group" id="variantMatrix">
                                    ...
                                    <div class="col-sm-10">
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <input type="hidden" name="optGroupRelArray" value=""
                                                   id="option-group-relationship"/>
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
                            ...
                            <div id="tab-recommendation" class="tab-pane">
                                <div class="alert alert-info" id="recommendations-loading"><i
                                            class="fa fa-cog fa-lg fa-spin"></i> <?php echo $text_check_recommendations; ?>
                                </div>
                                <div class="alert alert-danger" id="recommendations-danger" style="display:none;"><i
                                            class="fa fa-minus-circle"></i></div>
                                <div class="alert alert-success" id="recommendations-success" style="display:none;"><i
                                            class="fa fa-check-circle"></i> <?php echo $text_success_recommendations; ?>
                                </div>
                            </div>
                        </div>
                    </form>
                    <div class="well">
                        <div class="row">
                            <div class="col-sm-12 text-right">
                                <a class="btn btn-danger" id="button-end-item"><i
                                            class="fa fa-minus-circle"></i> <?php echo $button_end; ?></a>
                                <a class="btn btn-danger" id="button-remove-link"><i
                                            class="fa fa-minus-circle"></i> <?php echo $button_remove; ?></a>
                                <a class="btn btn-primary" href="<?php echo $view_link; ?>" target="_BLANK"
                                   data-toggle="tooltip" title="<?php echo $button_view; ?>"><i
                                            class="fa fa-external-link"></i></a>
                                <a class="btn btn-primary" id="button-edit-item" data-toggle="tooltip"
                                   title="<?php echo $button_edit; ?>" style="display:none;"><i
                                            class="fa fa-pencil"></i></a>
                                <a class="btn btn-primary" id="button-save" data-toggle="tooltip"
                                   title="<?php echo $button_save; ?>"><i class="fa fa-save"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
