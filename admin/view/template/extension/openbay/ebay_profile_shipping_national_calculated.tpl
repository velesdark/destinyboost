<input type="hidden" value="<?php echo (int)$data['national']['calculated']['count']; ?>"
       id="calculated_count_national"/>
...
<div class="well" id="national_calculated_<?php echo $key; ?>">
    ...
    <div class="row">
        <div class="col-sm-2 pull-right text-right">
            <a onclick="removeShipping('national','<?php echo $key; ?>', 'calculated');" class="btn btn-danger"><i
