...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <a href="<?php echo $url_remove_errors; ?>" data-toggle="tooltip"
                   title="<?php echo $button_remove_error; ?>" class="btn btn-danger"><i class="fa fa-reply"></i></a>
                <?php } ?>
                <a href="<?php echo $cancel_url; ?>" data-toggle="tooltip" title="<?php echo $button_cancel; ?>"
    ...
    <div class="container-fluid">
            ...
            <div class="tab-content" id="tab-content">
                <div class="tab-pane active" id="page-main">
                        ...
                        <div class="col-sm-10">
                            <p><a href="<?php echo $listing_url; ?>"><?php echo $listing_name; ?>
                                ...
                                <select id="openstock_selector" name="optionVar" class="form-control">
                                    ...
                                    <option
                                    <?php if ($variation == $option['sku']) { echo "selected='selected'"; $option_selected = true; } ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" id="marketplaces">
                            ...
                            <label class="radio-inline">
                                ...
                                <input class="marketplace_ids"
                                       id="adv_marketplace_<?php echo $mp['code']; ?>" <?php if (in_array($mp['id'], $default_marketplaces)) { ?>
                                checked="checked" <?php } ?> type="radio" name="marketplace_ids[]"
                                value="<?php echo $mp['id']; ?>">
                                <?php } else { ?>
                                <input class="marketplace_ids"
                                       id="adv_marketplace_<?php echo $mp['code']; ?>" <?php if (in_array($mp['id'], $saved_marketplaces)) { ?>
                                checked="checked" <?php } ?> type="radio" name="marketplace_ids[]"
                                value="<?php echo $mp['id']; ?>">
                                <?php } ?>
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="category_selector"
                               id="category_selector_label"><?php echo $entry_category; ?></label>
                        <div class="col-sm-4">
                            <select name="category_selector" id="category_selector" class="form-control">
                                <option value=""></option>
                                <?php foreach($amazon_categories as $category) {  ?>
                                <option
                                <?php if ($edit_product_category == $category["name"]) echo 'selected="selected"'; ?>
                                value="<?php echo $category['template']; ?>
                                "><?php echo $category['friendly_name']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
        ...
        <div class="well">
            <div class="row">
                <div class="col-md-12 text-right"><a class="btn btn-primary" data-toggle="tooltip"
                                                     title="<?php echo $button_save; ?>"
                                                     onclick="validate_and_save('advanced')"><i
                                class="fa fa-save fa-lg"></i></a> <a class="btn btn-primary" data-toggle="tooltip"
                                                                     title="<?php echo $button_save_upload; ?>"
                                                                     onclick="save_and_upload()"><i
                                class="fa fa-cloud-upload fa-lg"></i></a> <a class="btn btn-primary"
                                                                             data-toggle="tooltip"
                                                                             title="<?php echo $button_saved_listings; ?>"
                                                                             href="<?php echo $saved_listings_url; ?>"><i
                                class="fa fa-copy fa-lg"></i></a></div>
            </div>
        </div>
    </div>
</div>
