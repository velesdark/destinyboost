...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <p><a href="<?php echo $link_register; ?>" class="btn btn-primary"
                  target="_blank"><?php echo $button_register; ?></a></p>
        </div>
        <?php } else { ?>
        <div class="row">
            <div class="col-md-4">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="text-left"><?php echo $user_plan['merchant_id']; ?> [ <a
                                            href="<?php echo $link_change_seller; ?>"
                                            target="_blank"><?php echo $text_change_merchantid; ?></a> ]
                                </td>
                            </tr>
                            <tr>
            ...
            <div class="col-md-8">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="pull-right"><a href="<?php echo $link_change_plan; ?>" class="btn btn-primary"
                                                   target="_blank"><i
                                        class="fa fa-arrow-right fa-lg"></i> <?php echo $button_change_plan; ?></a>
                        </div>
                        <?php } ?>
                    </div>
                </div>
