        ...
        <div class="well">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <label class="control-label"
                               for="marketplace-select"><?php echo $text_choose_marketplace; ?></label>
                        <select name="marketplace_select" id="marketplace-select" class="form-control">
                            <?php foreach ($marketplaces as $marketplace) { ?>
                            <option value="<?php echo $marketplace['link']; ?>"
                            <?php if ($marketplace['code'] == $marketplace_code) { echo ' selected'; } ?>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="pull-right"><a class="btn btn-primary" disabled="disabled"><i
                                    class="fa fa-cog fa-lg fa-spin"></i> <?php echo $text_loading; ?></a></div>
                    <?php } else { ?>
                    <div class="pull-right"><a id="button-load-listings" class="btn btn-primary"
                                               href="<?php echo $marketplaces[$marketplace_code]['href_load_listings']; ?>"><?php echo $button_load; ?></a>
                    </div>
                    <?php } ?>
                </div>
            </div>
        ...
        <form id="bulk-link-form" class="form-horizontal">
            <div id="text-<?php echo $marketplace_code; ?>">
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        <th class="text-center"><input type="checkbox" id="master-checkbox"
                                                       value="<?php echo $marketplace['code']; ?>"/></th>
                    ...
                    <tr class="success">
                        <td class="text-center"><input type="checkbox"
                                                       class="link-checkbox link-checkbox-<?php echo $marketplace['code']; ?>"/>
                        </td>
                        <?php } ?>

                        <td class="text-left"><a href="<?php echo $product['href_amazon']; ?>"
                                                 target="_blank"><?php echo $product['asin']; ?></a></td>
                        ...
                        <td class="text-left"><a href="<?php echo $product['href_product']; ?>"
                                                 target="_blank"><?php echo $product['name']; ?></a><?php echo (!empty($product['combination']) ? '<br />
                            ' . $product['combination'] : ''); ?>
                        </td>
                        <td class="text-left"><?php echo $product['sku']; ?></td>
                        <td class="text-center"><?php echo $product['quantity']; ?></td>
                        <input type="hidden" name="link[<?php echo $row; ?>][amazon_sku]"
                               value="<?php echo $product['amazon_sku']; ?>"/>
                        <input type="hidden" name="link[<?php echo $row; ?>][product_id]"
                               value="<?php echo $product['product_id']; ?>"/>
                        <input type="hidden" name="link[<?php echo $row; ?>][sku]"
                               value="<?php echo $product['var']; ?>"/>
                    </tr>
                    <?php } ?>
                    </tbody>
                </table>
                <div class="well">
                    <div class="row">
                        <div class="col-sm-12 text-right">
                            <div class="pull-right"><a id="link-button" class="btn btn-primary"
                                                       href="<?php echo $button_save; ?>" data-toggle="tooltip"
                                                       title="<?php echo $button_load; ?>"><i
