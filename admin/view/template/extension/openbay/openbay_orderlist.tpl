                ...
                <div class="well">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label"
                                       for="input-channel"><?php echo $entry_order_channel; ?></label>
                                <select name="filter_channel" id="input-channel" class="form-control">
                                    <option value=""></option>
                                    <?php foreach ($channels as $channel) { ?>
                                    <?php if ($channel['module'] == $filter_channel) { ?>
                                    <option value="<?php echo $channel['module']; ?>"
                                            selected="selected"><?php echo $channel['title']; ?></option>
                                    <?php } else {  ?>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <a data-toggle="tooltip" title="<?php echo $button_filter; ?>"
                                           class="btn btn-primary input-group-addon"
                                           onclick="$('#order-update-form').submit();"><i
                                                    class="fa fa-plus-circle"></i> <?php echo $button_status; ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th class="text-left"><?php if ($sort == 'channel') { ?>
                                    <a href="<?php echo $sort_channel; ?>"
                                       class="<?php echo strtolower($order); ?>"><?php echo $column_channel; ?></a>
                                    <?php } else { ?>
