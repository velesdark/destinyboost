    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="alert alert-success" id="alert-link-save" style="display:none;"><i class="fa fa-check fa-lg"
                                                                                               style="color:green"></i> <?php echo $text_link_saved; ?>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr id="row-<?php echo $item['etsy_listing_id']; ?>">
                            ...
                            <td class="text-center"><a href="<?php echo $item['link_etsy']; ?>"
                                                       target="_BLANK"><?php echo $item['etsy_item_id']; ?></a></td>
                            ...
                            <td class="text-center">
                                <button class="btn btn-danger"
                                        id="row-delete-btn-<?php echo $item['etsy_listing_id']; ?>"
                                        onclick="deleteLink('<?php echo $item['etsy_listing_id']; ?>')"><i
