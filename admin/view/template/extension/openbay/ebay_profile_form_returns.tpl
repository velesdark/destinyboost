                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab-returns">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="data[returns_accepted]" class="form-control">
                                        ...
                                        <option value="<?php echo $v['ReturnsAcceptedOption']; ?>"
                                        <?php if ($data['returns_accepted'] == $v['ReturnsAcceptedOption']){ echo'selected'; } ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="data[returns_within]" class="form-control">
                                        ...
                                        <option value="<?php echo $v['ReturnsWithinOption']; ?>"
                                        <?php if ($data['returns_within'] == $v['ReturnsWithinOption']){ echo'selected'; } ?>
                                        ><?php echo $v['Description']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="data[returns_shipping]" class="form-control">
                                        ...
                                        <option value="<?php echo $v['ShippingCostPaidByOption']; ?>"
                                        <?php if ($data['returns_shipping'] == $v['ShippingCostPaidByOption']){ echo'selected'; } ?>
                                        ><?php echo $v['Description']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="data[returns_option]" class="form-control">
                                        ...
                                        <option value="<?php echo $v['RefundOption']; ?>"
                                        <?php if ($data['returns_option'] == $v['RefundOption']){ echo'selected'; } ?>
                                        ><?php echo $v['Description']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="data[returns_policy]" class="form-control" rows="3"
                                              maxlength="5000"><?php echo $data['returns_policy'];?></textarea>
                                </div>
                            </div>
                            <?php } else { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="data[returns_restocking_fee]" class="form-control">
                                        ...
                                        <option value="<?php echo $v['RestockingFeeValueOption']; ?>"
                                        <?php if ($data['returns_restocking_fee'] == $v['RestockingFeeValueOption']){ echo'selected'; } ?>
                                        ><?php echo $v['Description']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
