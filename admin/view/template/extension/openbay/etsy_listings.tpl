                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="keywords"
                                       value="<?php echo isset($filter['keywords']) ? $filter['keywords'] : ''; ?>"
                                       placeholder="<?php echo $entry_keywords; ?>" id="input-keywords"
                                       class="form-control"/>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="status" id="input-status" class="form-control">
                                    <option value="active"
                                    <?php if ($filter['status'] == 'active') { echo ' selected'; } ?>>Active</option>
                                    <option value="inactive"
                                    <?php if ($filter['status'] == 'inactive') { echo ' selected'; } ?>
                                    >Inactive</option>
                                    <option value="draft"
                                    <?php if ($filter['status'] == 'draft') { echo ' selected'; } ?>>Draft</option>
                                    <option value="expired"
                                    <?php if ($filter['status'] == 'expired') { echo ' selected'; } ?>>Expired</option>
                                </select>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="add_link_product" value=""
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="add_link_etsy_id" value=""
                                       placeholder="<?php echo $entry_etsy_id; ?>" id="input-etsy-id"
                                       class="form-control"/>
                            </div>
                            <a onclick="addLink();" class="btn btn-primary pull-right" id="button-submit-link"><i
                                        class="fa fa-check"></i> <?php echo $button_save; ?></a></div>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered table-hover">
                       ...
                       ?></td>
                            ...
                            <td class="text-right"><?php if (in_array('activate_item', $listing['actions'])) { ?>
                                <button data-toggle="tooltip" title="<?php echo $text_activate; ?>"
                                        class="btn btn-primary"
                                        onclick="activateListing('<?php echo $listing['listing']['listing_id']; ?>');"
                                        id="btn-activate-<?php echo $listing['listing']['listing_id']; ?>"><i
                                            class="fa fa-plus"></i></button>
                                <?php } ?>
                                <?php if (in_array('add_link', $listing['actions'])) { ?>
                                <button data-toggle="tooltip" title="<?php echo $text_add_link; ?>"
                                        class="btn btn-primary"
                                        onclick="showLinkOption('<?php echo $listing['listing']['listing_id']; ?>');"><i
                                            class="fa fa-link"></i></button>
                                <?php } ?>
                                <?php if (in_array('delete_link', $listing['actions'])) { ?>
                                <button data-toggle="tooltip" title="<?php echo $text_delete_link; ?>"
                                        class="btn btn-danger"
                                        id="btn-delete-<?php echo $listing['link']['etsy_listing_id']; ?>"
                                        onclick="deleteLink('<?php echo $listing['link']['etsy_listing_id']; ?>');"><i
                                            class="fa fa-unlink"></i></button>
                                <?php } ?>
                                <?php if (in_array('end_item', $listing['actions'])) { ?>
                                <button data-toggle="tooltip" title="<?php echo $text_delete; ?>" class="btn btn-danger"
                                        onclick="endListing('<?php echo $listing['listing']['listing_id']; ?>');"
                                        id="btn-end-<?php echo $listing['link']['etsy_listing_id']; ?>"><i
                                            class="fa fa-times"></i></button>
                                <button data-toggle="tooltip" title="<?php echo $text_deactivate; ?>"
                                        class="btn btn-danger"
                                        onclick="deactivateListing('<?php echo $listing['listing']['listing_id']; ?>');"
                                        id="btn-deactivate-<?php echo $listing['listing']['listing_id']; ?>"><i
