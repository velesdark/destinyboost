                        ...
                        <div class="tab-content">
                            <div id="tab-listing-general" class="tab-pane active">
                                <div class="form-group required">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="title" value="<?php echo $listing['title']; ?>"
                                ...
                                <div class="form-group required">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="description" placeholder="<?php echo $entry_description; ?>"
                                                  ...
                                                  class="form-control"><?php echo $listing['description']; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group required">
                                    <label class="col-sm-2 control-label"
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="price" value="<?php echo $listing['price']; ?>"
                                ...
                                <div class="form-group required">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="state" id="input-state" class="form-control">
                                            ...
                                            <?php echo ($listing['state'] == $value) ? ' selected' : ''; ?>
                            ...
                            <div class="well">
                                <div class="row">
                                    <div class="col-sm-12 text-right">
                                        <a data-toggle="tooltip" title="<?php echo $button_save; ?>"
                                           class="btn btn-primary" id="button-save"><i class="fa fa-save"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
