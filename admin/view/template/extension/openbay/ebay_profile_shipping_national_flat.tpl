...
<div class="well" id="national_flat_<?php echo $key; ?>">
    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            <input type="text" name="data[national][flat][price][<?php echo $key; ?>]" class="form-control"
                   value="<?php echo $data['national']['flat']['price'][$key]; ?>"/>
        </div>
        <div class="col-sm-2 text-right">
            <label class="control-label"><?php echo $text_shipping_add; ?></label>
        </div>
        <div class="col-sm-3">
            <input type="text" name="data[national][flat][price_additional][<?php echo $key; ?>]" class="form-control"
                   value="<?php echo $data['national']['flat']['price_additional'][$key]; ?>"/>
        </div>
        <div class="col-sm-3 pull-right text-right">
            <a onclick="removeShipping('national','<?php echo $key; ?>', 'flat');" class="btn btn-danger"><i
