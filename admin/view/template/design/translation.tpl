                ...
                <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-layout">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                <td class="text-left"><img src="<?php echo $list['image']; ?>" height="48"
                                                           width="48"></img></td>
                                ...
                                <td class="text-left">
                                    <div class="progress">
                                        ...
                                        <div class="progress-bar progress-bar-success progress-bar-striped"
                                             ...
                                             style="min-width: 2em; width:<?php echo $list['progress']; ?>%"><?php echo $list['progress']; ?>
                                            % Complete (success)
                                        </div>
                                ...
                                <td class="text-right">
                                    ...
                                    <a href="<?php echo $list['install']; ?>" data-toggle="tooltip"
                                       title="<?php echo $button_install; ?>" class="btn btn-success"><i
                                    ...
                                    <a href="<?php echo $list['uninstall']; ?>" data-toggle="tooltip"
