...
$_['entry_insurance'] = 'Ставок компенсации';
$_['entry_display_weight'] = 'Вес товара к доставке дисплей';
$_['entry_display_insurance'] = 'Отображения страхование';
...
$_['help_insurance'] = 'Введите значения до 5,2 десятичных разрядов. (12345.67) пример: 34:0, плечом, 250:2.25 - страхование для корзину значения по 34 будет стоить 0.00 дополнительных, тех, кто ценит больше, чем 100 и по 250 будет стоить 2,25 дополнительные. Не вводите символы валют.';
...
// Tab
$_['tab_special_delivery_500'] = 'Срочная доставка на следующий день (&pound;500)';
$_['tab_special_delivery_1000'] = 'Срочная доставка на следующий день (&pound;1000)';
$_['tab_special_delivery_2500'] = 'Срочная доставка на следующий день (&pound;2500)';
$_['tab_1st_class_signed'] = '1st Class Signed';
$_['tab_2nd_class_signed'] = '2nd Class Signed';
$_['tab_1st_class_standard'] = 'Стандартная почта первого класса';
$_['tab_2nd_class_standard'] = 'Стандартная почта второго класса';
